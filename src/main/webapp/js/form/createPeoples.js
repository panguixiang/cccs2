...
function changetype(type,str){
	switch (type) {
		...
		case "Z21":
			...
			document.all('opusName').tips ="请填写涉及作品名称,作品量多于五个时，提交作品清单作为附件，不必在此全部列出。";
			if(str == "Z61"){
	...
	function allCheck() {
		var checkboxs = document.getElementsByName("right_scope");
	...
	/*著作权人信息 - 我是著作权人-姓名名称*/
	function setMyCustor(name,obj) {
		var obj1 = document.all(obj);   
	     obj1[obj1.length-1].innerHTML = name;
	}
