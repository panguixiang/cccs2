...
with (document){
	...
	write("<tr><td align='center'>");
	write("<b style='cursor:hand;font:bold 14 Default Sans Serif;color:#FFFFFF;' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=yqToggle'>今天：" + giYear + "年" + giMonth + "月" + giDay + "日</b><input type=button value=清除 onclick=cleanup() />");
