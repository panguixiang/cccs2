 ...
 onmouseout=cpcc_showtip() cols=25 name="publish_type" errmsg="请填写出版类型！" valid="required" length="1000" tips="请填写出版类型"></TEXTAREA> 
    ...
    class=contentbg colSpan=2>
      <TABLE id=changeItems border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() wrap="hard" name="item" errmsg="变更项不能为空！" valid="required" length="100" tips="请填写变更项"></TEXTAREA> 
          </TD>
          <TD 
          ...
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px">
          <TEXTAREA style="BORDER-RIGHT-WIDTH: 1px; WIDTH: 87%; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px" 
          onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() wrap="hard" name="after_content" errmsg="变更后内容不能为空！" valid="required" length="200" tips="请填写变更后内容说明"></TEXTAREA> 
  ...
  <TR>
    ...
    <TEXTAREA style="BORDER-RIGHT-WIDTH: 1px; WIDTH: 450px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"
     onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() wrap="hard"
      cols=200 name="rev_desc" errmsg="变更理由说明不能为空！" valid="required" length="200" tips="请填写变更理由说明"></TEXTAREA> 
    </TD></TR>
...
function setPeopleValue(str)
{
  ...
  <TR>
    ...
    <TD class=contentbg>
      <INPUT id="sqrpostCodeid" 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name="sqrpostCode" size=35 length="8" tips="请填写邮政编码">
      </TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT id="dlrpostCodeid" 
      ...
      valid="required" length="8" tips="请填写邮政编码"></TD></TR>
  <TR>
    <TD class=contentbg>联系人</TD>
