...
<head>
<title>在线查看-转让著作权质权登记事项申请表</title>
<STYLE>TABLE {
...
border=0 cellSpacing=0 cellPadding=0 width="100%" align=center>
  ...
  <TR>
    ...
    ?>
      <DIV class=title>转让著作权质权登记事项申请表</DIV></TD></TR></TBODY></TABLE>
  ...
  <TR>
    ...
    <TD>
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        <TBODY>
        <TR>
          <TH width=130>质权登记号</TH>
          <TD class=InputTd><c:out value='${z56.originalRegNumber}' /></TD></TR>
        <TR>
          <TH>质权登记日期</TH>
          <TD class=InputTd><c:out value='${z56.applyingType}' /></TD></TR>
        <TR>
          <TH>涉及作品名称</TH>
          <TD class=InputTd><c:out value='${z56.reason}' /></TD></TR>
        <TR>
          <TH>涉及作品种类</TH>
     <TD class=InputTd><SPAN 
       ...
       style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; LINE-HEIGHT: 11px; WIDTH: 11px; 
       FONT-SIZE: 10px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid"><c:if test="${口述 == '口述'}">√</c:if>
       </SPAN>&nbsp;口述 <SPAN 
       style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; LINE-HEIGHT: 11px; WIDTH: 11px; 
       FONT-SIZE: 10px; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid"><c:if test="${音乐 == '音乐'}">√</c:if> 
       </SPAN>&nbsp;音乐 <SPAN 
       ...
       </SPAN>&nbsp;其他 </TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
...
<TABLE border=2 cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    ...
    <TD>
      ...
      width="100%" frame=void align=center>
        <TBODY>
        <c:forEach items="${cps3}" var="cp3">
        <TR>
          <TH width=130>姓名或单位名称</TH>
          <TD colSpan=3>${cp2.name}</TD></TR>
        <TR>
          <TH>类别</TH>
          <TD colSpan=3>${cp3.people_type}</TD></TR>
        <TR>
          <TH>证件类型</TH>
          <TD>${cp3.id_type}</TD>
          <TH>证件号码</TH>
          <TD>${cp3.id_number}</TD></TR>
        <TR>
          <TH>法定代表人</TH>
          <TD>${cp3.hasLetter}</TD>
          <TH>电话</TH>
  ...
  <TR>
    ...
    <TD>
      ...
      height="100%">
        ...
        <TR>
          <TH width=130>原质权担保期限</TH>
          <TD class=InputTd>${info.item}</TD></TR>
        <TR>
          <TH width=130>转让著作权种类</TH>
          <TD class=InputTd>${info.before_content}</TD></TR>
        <TR>
          <TH width=130>转让质权范围</TH>
    ...
    <TD colSpan=2>
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR>
          ...
          <c:if test="${z56.applyType=='受让人申请'}">⊙</c:if>
		  <c:if test="${z56.applyType!='受让人申请'}">○</c:if>受让人申请&nbsp;
		  <c:if test="${z56.applyType=='转让人申请'}">⊙</c:if>
		  <c:if test="${z56.applyType!='转让人申请'}">○</c:if>转让人申请&nbsp;
		  <c:if test="${z56.isAgent=='代理人'}">
		   <SPAN 
            style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; LINE-HEIGHT: 11px; WIDTH: 11px;
      ...
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR height=80>
          <TD style="WIDTH: 630px" class=InputTd colSpan=4>
            ...
            id=agentDescU>${z56.agent_desc}</U> </DIV></TD></TR>
        <TR height=50>
          <TH style="WIDTH: 100px">姓名或名称</TH>
...
<TABLE border=2 cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    <TH>证明文件</TH>
    <TD class=InputTd>
      <DIV style="FLOAT: left">1、原著作权质权登记证书原件</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">2、原著作权质权登记证书复印件</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">3、出质人认同质权转让证明</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">4、著作权质权转让合同</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">5、原质权人与新质权人的主债务合同</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">6、委托协议</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">7、转让人身份证明</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">8、受让人身份证明</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">9、代理人委托书</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">10、代理人身份证明文件</DIV>
