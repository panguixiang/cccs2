...
cellPadding=0 width="100%" align=center>
  ...
  <TR height=35>
    <TD 
    style="BORDER-BOTTOM: gray 0px solid; TEXT-ALIGN: center; BORDER-LEFT: gray 0px solid; WIDTH: 100px; VERTICAL-ALIGN: middle; BORDER-TOP: gray 0px solid; BORDER-RIGHT: gray 0px solid">审查签字:</TD>
    ...
    <TD style="BORDER-BOTTOM: gray 0px solid"><SPAN 
      style="BORDER-BOTTOM: 0px; WIDTH: 100px"></SPAN></TD>
    <TD 
  ...
  <TR height=35>
    <TD 
    style="BORDER-BOTTOM: gray 0px solid; TEXT-ALIGN: center; BORDER-LEFT: gray 0px solid; WIDTH: 60px; VERTICAL-ALIGN: middle; BORDER-TOP: gray 0px solid; BORDER-RIGHT: gray 0px solid"></TD>
    <TD style="BORDER-BOTTOM: gray 0px solid; WIDTH: 120px"><SPAN 
      style="BORDER-BOTTOM: 0px; WIDTH: 110px"></SPAN></TD>
    <TD 
    style="BORDER-BOTTOM: gray 0px solid; TEXT-ALIGN: center; BORDER-LEFT: gray 0px solid; WIDTH: 70px; VERTICAL-ALIGN: middle; BORDER-TOP: gray 0px solid; BORDER-RIGHT: gray 0px solid"></TD>
    <TD style="BORDER-BOTTOM: gray 0px solid"><SPAN 
      style="BORDER-BOTTOM: 0px; WIDTH: 140px"></SPAN></TD></TR></TBODY></TABLE>
<TABLE 
...
border=0 cellSpacing=0 cellPadding=0 width="100%" align=center>
  ...
  <TR>
    ...
    style="BORDER-BOTTOM: gray 0px solid; BORDER-LEFT: gray 0px solid; VERTICAL-ALIGN: middle; BORDER-TOP: gray 0px solid; BORDER-RIGHT: gray 0px solid">
      <DIV class=title>撤回计算机软件登记申请表</DIV></TD></TR></TBODY></TABLE>
  ...
  <TR>
    ...
    <TD>
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        <TBODY>
        <TR height=30>
          <TH width=102>登记类别</TH>
          <TD class=InputTd width=528 colSpan=3>
           <c:if test="${r43_4.originalRegType=='软件著作权登记'}">⊙</c:if> 
           <c:if test="${r43_4.originalRegType!='软件著作权登记'}">○</c:if>&nbsp;软件著作权登记&nbsp; 
           <c:if test="${r43_4.originalRegType=='软件著作权转让合同登记'}">⊙</c:if> 
           <c:if test="${r43_4.originalRegType!='软件著作权转让合同登记'}">○</c:if>&nbsp;软件著作权转让合同登记&nbsp;
		   <c:if test="${r43_4.originalRegType=='软件著作权专有许可合同登记'}">⊙</c:if> 
		   <c:if test="${r43_4.originalRegType!='软件著作权专有许可合同登记'}">○</c:if>&nbsp;软件著作权专有许可合同登记&nbsp;
		   <c:if test="${r43_4.originalRegType=='软件著作权变更或补充登记'}">⊙</c:if> 
		   <c:if test="${r43_4.originalRegType!='软件著作权变更或补充登记'}">○</c:if>&nbsp;软件著作权变更或补充登记&nbsp;
          </TD></TR>
        <TR height=30>
          <TH width=102>受理号</TH>
          <TD class=InputTd width=300><c:out value='${r43_4.handleNumber}' /></TD>
          <TH width=100>受理日期</TH>
          <TD class=InputTd width=128><c:out value='${r43_4.handleDate}' /></TD></TR>
        <TR height=70>
          <TH width=102>软件名称及版本号</TH>
          <TD class=InputTd width=528 colSpan=3><c:out value='${r43_4.softName}' /></TD></TR>
        <TR height=70>
          <TH width=102>撤回登记理由</TH>
          <TD class=InputTd width=528 
      colSpan=3><c:out value='${r43_4.reason}' /></TD></TR>
      </TBODY></TABLE></TD></TR>
  <TR>
    <TD colSpan=5>
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR>
          ...
          <TD style="WIDTH: 530px" class=InputTd 
            colSpan=3>
            	<c:if test="${r43_4.applyType=='由著作权人申请办理'}">⊙</c:if>
				<c:if test="${r43_4.applyType!='由著作权人申请办理'}">○</c:if>由著作权人申请办理&nbsp;&nbsp;
				<c:if test="${r43_4.applyType=='由合同当事人申请办理'}">⊙</c:if>
				<c:if test="${r43_4.applyType!='由合同当事人申请办理'}">○</c:if>由合同当事人申请办理&nbsp;&nbsp;
				<c:if test="${r43_4.applyType=='由变更或补充登记人申请办理'}">⊙</c:if>
				<c:if test="${r43_4.applyType!='由变更或补充登记人申请办理'}">○</c:if>由变更/补充登记人申请办理&nbsp;&nbsp;
      ...
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR height=30>
          ...
          <TD style="WIDTH: 90px" class=InputTd>${dlr.fax}</TD></TR></TBODY></TABLE></TD></TR>
           <c:if test="${r43_4.hasGtsqr == '有共同申请人'}">
  <TR style="HEIGHT: 20px">
    <TD class=InputTd colSpan=2>&nbsp;&nbsp;共同申请人意见:<BR>
      <DIV 
      align=right>共同申请人签章：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</DIV>
      <P align=right><fmt:formatDate value="${now}" pattern="yyyy 年  MM 月  dd 日"/>&nbsp;</P></TD></TR>
      </c:if>
...
style="LINE-HEIGHT: 5px; PAGE-BREAK-AFTER: always">
...
<TABLE border=2 cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    ...
    <c:if test="${r43_4.hasGtsqr == '有共同申请人'}">
      ...
      <DIV style="FLOAT: right">一式一份</DIV>
      </c:if>
      <BR></TD></TR>
  <TR>
