...
<input type="hidden" value="${z74.flow_num}" name="flow_num" />
...
cellSpacing=0 borderColor=#cccccc cellPadding=0 width="80%" align=center>
  ...
  align=center><B>在线填报-撤回出版境外音像制品合同登记申请表</B></TD></TR></TBODY></TABLE>
...
border=0 cellSpacing=0 cellPadding=0 width="80%" align=center>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT id="registerTypeid" name="register_type" value="录音制品" 
       type="radio" <c:if test="${z74.register_type=='录音制品'}">checked="checked"</c:if> />录音制品&nbsp;&nbsp;
    <INPUT id="registerTypeid" name="register_type" value="影视作品" type="radio"
    <c:if test="${z74.register_type=='影视作品'}">checked="checked"</c:if> />影视作品&nbsp;&nbsp; </TD></TR>
  <TR>
      ...
      width="100%">
        ...
        <TR>
          ...
          vAlign=bottom><INPUT style="WIDTH: 100%" id="cn_opus_nameid" 
            ...
            valid="required" length="200" tips="请填写中文名" value="<c:out value='${z74.cn_opus_name}' />" /> </TD></TR>
        <TR>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
        ...
        tips="请填写英文名称" value="<c:out value='${z74.en_opus_name}' />" /></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
 ...
 valid="required" length="1000" tips="请填写出版类型"><c:out value='${z74.publish_type}' /></TEXTAREA> 
    </TD></TR>
  <TR>
    <TD class=contentbg>原受理号</TD>
    <TD 
    style="BORDER-RIGHT-WIDTH: 0px; WIDTH: 90%; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
    vAlign=top><INPUT style="WIDTH: 100%" id="original_reg_numid" 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name="original_reg_num" errmsg="请填写原受理号！" 
      valid="required" length="200" tips="请填写原受理号！" value="<c:out value='${z74.original_reg_num}' />" /></TD></TR>
  <TR>
    <TD class=contentbg>原受理日期</TD>
    <TD class=contentbg><INPUT id="register_dateid" 
      ...
      name="register_date"  size=12 errmsg="请填写原受理日期！" valid="required" 
      tips="请填写原受理日期！" value="<c:out value='${z74.register_date}' />" readOnly /> </TD></TR>
  <TR>
    <TD class=contentbg noWrap>出版单位名称</TD>
    <TD class=contentbg><INPUT style="WIDTH: 100%" id="publis_comp_nameid" 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name="publis_comp_name" errmsg="请填写出版单位名称！" 
      valid="required" length="200" tips="请填写出版单位名称！" value="<c:out value='${z74.publis_comp_name}' />" /></TD></TR>
  <TR>
  ...
  <TR>
    ...
    cols=25 name="rev_desc" errmsg="请填写撤销登记理由！" valid="required" length="1000" tips="请填写撤销登记理由">
    <c:out value='${z74.rev_desc}' /></TEXTAREA> 
    </TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT onclick=agent_showOrHide(this) name="apply_type" 
      ...
      <c:if test="${z74.apply_type=='原出版单位申请'}">checked="checked"</c:if> />原出版单位申请
 <INPUT onclick=agent_showOrHide(this) name="apply_type" 
  value="代理人" type="radio" <c:if test="${z74.apply_type=='代理人'}">checked="checked"</c:if> />由代理人申请 
    </TD></TR>
  <SCRIPT>
...
function setPeopleValue(str)
{
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT id="sqrpostCodeid" 
      ...
      onmouseout=cpcc_showtip() name="sqrpostCode" size=35 length="6" 
  ...
  <TR>
    <TD class=contentbg 
      ...
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name="agent_desc" size=60 errmsg="代理权限说明不能为空！" value="<c:out value='${z74.agent_desc}' />" /
...
<TABLE align=center>
  ...
  <TR>
   ...
   <input type="button" value="保存" id="saveId" 
			 class="m_button" onClick="saveForm('${pageContext.request.contextPath}/application/z74/save');"/>
    </TD>
    <TD width=50 style=" padding-right:16px;">
    <input type="button" value="提交" id="subId" class="m_button" 
    onClick="subForm('${pageContext.request.contextPath}/application/z74/submit');"/>
    </TD>
   <td>
