...
border=1 cellSpacing=0 cellPadding=0 width="80%" align=center>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,500) 
      onmouseout=cpcc_showtip() name="originalRegType" value="软件著作权登记"  CHECKED 
      type=radio tips="按照所要变更的类别进行选择。">软件著作权登记 <INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,500) 
      onmouseout=cpcc_showtip() name=originalRegType value="软件著作权转让合同登记 "
      type=radio tips="按照所要变更的类别进行选择。">软件著作权转让合同登记 <INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,500) 
      onmouseout=cpcc_showtip() name=originalRegType value="软件著作权专有许可合同登记" 
      type=radio tips="按照所要变更的类别进行选择。">软件著作权专有许可合同登记 </TD></TR>
  <TR>
    ...
    <TD class=contentbg><INPUT 
      ...
      errmsg="原登记号不能为空!" valid="required"></TD></TR>
  <TR>
    <TD class=contentbg>原变更/补充登记证明编号</TD>
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,500) 
      onmouseout=cpcc_showtip() name=originalChangeNumber 
      tips="如做过变更或补充登记的，需填写软件著作权变更/补充登记证明的编号。" length="40"></TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT 
      ...
      value="变更登记" CHECKED type=radio tips="对原著作权登记事项和合同登记事项的补充。" />变更登记 <INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,500) 
      onmouseout=cpcc_showtip() onclick=showApplyingType() name="applyingType" 
      value="补充登记" type=radio tips="对原著作权登记事项和合同登记事项的补充。" />补充登记 </TD></TR>
        ...
        <TR>
          ...
          style="BORDER-RIGHT-WIDTH: 1px; WIDTH: 169px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px"><SELECT 
			...
			tips="请填写变更项或补充项" valid="" errmsg="变更项或补充项不能为空！"> <OPTION selected 
              ...
              value=首次发表日期>首次发表日期</OPTION></SELECT> </TD>
          <TD 
		 ...
		 errmsg="变更前内容或补充前内容不能为空！" length="200"></TEXTAREA> 
          </TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
          align=left>
          <INPUT  
        id="afterContent2_" onmousemove=cpcc_showtip(this.tips,this.valid,this.length,250) 
      onmouseout=cpcc_showtip() onClick="fPopCalendar(this, this);"  
       name="afterContent2_"  length="200" value="" errmsg="请填写原登记日期！"
       tips="变更或补充后的内容,请注意版本号中数字部分不可更改。" /> 
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          align=center>
            ...
            <DIV style="FLOAT: right"><INPUT style=" padding:0 3px;"  onmousemove=cpcc_showtip(this.tips,this.valid,this.length,100) 
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR>
          ...
          style="BORDER-RIGHT-WIDTH: 1px; WIDTH: 169px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px"><SELECT 
            ...
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name="item" wrap="hard" rows="2" style="width: 130px"
          ...
          style="BORDER-RIGHT-WIDTH: 1px; WIDTH: 220px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH:
           ...
           onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() 
           name="before_content" wrap="hard"
		rows="3" tips="变更或补充前的内容。" valid="required" errmsg="变更或补充前内容不能为空！" length="200"></TEXTAREA> 
          </TD>
          <TD 
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR>
          ...
          BORDER-LEFT-WIDTH: 0px"><TEXTAREA style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px;
           ...
           onmouseout=cpcc_showtip() name="before_content" wrap="hard" rows="3"
          tips="变更或补充前的内容。" valid="required" errmsg="变更或补充前内容不能为空！" length="200"></TEXTAREA> 
          </TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
  ...
  <TR>
    ...
    wrap=hard cols=200 rows=3 name="reason" tips="简明扼要地说明登记事项和内容变更或补充的理由，变更理由填写应规范，如企业名称变更的可填写&nbsp;“依工商局核准，企业名称已经发生变更，现申请著作权人名称变更”。需要提交证明的，则应当附具相关的证明文件。" length="200" errmsg="变更理由说明不能为空！" valid="required"></TEXTAREA> 
    </TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT onclick=agent_showOrHide(this) name="applyType" 
      value="由著作权人办理" CHECKED type=radio />由著作权人办理 <INPUT 
      onclick=agent_showOrHide(this) name="applyType" value="由合同登记人办理" 
      type=radio />由合同登记人办理 <INPUT onclick=agent_showOrHide(this) name="applyType" 
      value="代理人" type=radio />由代理人办理 </TD></TR>
  <SCRIPT>
