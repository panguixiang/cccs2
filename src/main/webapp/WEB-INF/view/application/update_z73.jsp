...
<input type="hidden" value="${z73.flow_num}" name="flow_num" />
...
border=0 cellSpacing=0 cellPadding=0 width="80%" align=center>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT id="registerTypeid" name="register_type" value="录音制品" 
       type="radio" <c:if test="${z73.register_type=='录音制品'}">checked="checked"</c:if> />录音制品&nbsp;&nbsp;
    <INPUT id="registerTypeid" name="register_type" value="影视作品" type="radio"
    <c:if test="${z73.register_type=='影视作品'}">checked="checked"</c:if> />影视作品&nbsp;&nbsp; </TD></TR>
  <TR>
      ...
      width="100%">
        ...
        <TR>
          ...
          vAlign=bottom><INPUT style="WIDTH: 448px" id="cn_opus_nameid" 
            ...
            valid="required" length="200" tips="请填写中文名" value="<c:out value='${z73.cn_opus_name}' />" /> </TD></TR>
        <TR>
          <TD 
          style="BORDER:0px" 
        ...
        tips="请填写英文名称" value="<c:out value='${z73.en_opus_name}' />" /></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
 ...
 valid="required" length="1000" tips="请填写出版类型"><c:out value='${z73.publish_type}' /></TEXTAREA> 
    </TD></TR>
  <TR>
    <TD class=contentbg>原登记号</TD>
    <TD 
    style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px;background:#e3f4ff;" 
    vAlign=top><INPUT style="WIDTH: 497px;" id="original_reg_numid" 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name="original_reg_num" errmsg="请填写原登记号！" 
      valid="required" length="200" tips="请填写原登记号" value="<c:out value='${z73.original_reg_num}' />" /></TD></TR>
  <TR>
    ...
    <TD class=contentbg><INPUT id="register_dateid" 
      ...
      tips="请填写原登记日期" value="<c:out value='${z73.register_date}' />" readOnly /> </TD></TR>
  <TR>
    ...
    <TD class=contentbg><INPUT style="WIDTH:497px" id="publis_comp_nameid" 
      ...
      valid="required" length="200" tips="请填写出版单位名称" value="<c:out value='${z73.publis_comp_name}' />" /></TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT id="rev_typeid" name="rev_type" value="原登记申请人申请撤销 "
      type="radio" <c:if test="${z73.rev_type=='原登记申请人申请撤销'}">checked="checked"</c:if> />原登记申请人申请撤销&nbsp;&nbsp; <INPUT id="rev_typeid" 
      name="rev_type" value="其他" type="radio" <c:if test="${z73.rev_type=='其他'}">checked="checked"</c:if> />其他&nbsp;&nbsp; </TD></TR>
  <TR>
    <TD class=contentbg>撤销登记理由</TD>
    <TD class=contentbg>
    <TEXTAREA style="WIDTH:497px" onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() 
    cols=25 name="rev_desc" errmsg="请填写撤销登记理由！" valid="required" length="1000" tips="请填写撤销登记理由">
    <c:out value='${z73.rev_desc}' /></TEXTAREA> 
    </TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT onclick=agent_showOrHide(this) name="apply_type" 
      ...
      <c:if test="${z73.apply_type=='原出版单位申请'}">checked="checked"</c:if> />原出版单位申请
 <INPUT onclick=agent_showOrHide(this) name="apply_type" 
  value="代理人" type="radio" <c:if test="${z73.apply_type=='代理人'}">checked="checked"</c:if> />由代理人申请 
    </TD></TR>
  <SCRIPT>
...
function setPeopleValue(str)
{
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT id="sqrpostCodeid" 
      ...
      tips="请填写邮政编码" length="8" 
        value="<c:out value='${sqr.post_code}' />" /></TD></TR>
  <TR>
  ...
  <TR>
    <TD class=contentbg 
      ...
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name="agent_desc" size=60 errmsg="代理权限说明不能为空！" value="<c:out value='${z73.agent_desc}' />" /
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT id="dlrpostCodeid" 
      ...
      errmsg="不能为空！" valid="required" length="8" tips="请填写邮政编码" value="<c:out value='${dlr.post_code}' />" /></TD></TR>
  <TR>
    <TD class=contentbg>联系人</TD>
