							...
							<tr>
								...
								<td>
									...
									<div id="z21_opus" style="display: none; float: left;">
											作品数量:&nbsp;<INPUT type="text" name=more_opus id="more_opusId" value=""
						...
						<tbody>
							...
							<tr>
							 ...
							 <tr id="changTypId1" style="">
     							 	<td>补发或更换证书类型</td>
	  								<td>
									<input type="radio" name="change_type1" value="登记证书" checked>登记证书&nbsp;&nbsp;
									<input type="radio" name="change_type1" value="变更或补充证明" >变更或补充证明&nbsp;&nbsp;
	  							</td>
							</tr>
							<tr id="changTypId2" style="display: none;">
     							 	<td>补发或更换证书类型</td>
	  								<td>
									<input type="radio" name="change_type2" value="著作权质权登记证书" checked>著作权质权登记证书&nbsp;&nbsp;
									<input type="radio" name="change_type2" value="变更或补充证明" >变更或补充证明&nbsp;&nbsp;
	  							</td>
							</tr>
						<tr>
								<td><span id="z62rn">补发或更换的理由</span>
								</td>
								<td><textarea class="focus" name="reason" wrap="hard"
										rows="2" cols="200" style="width: 500px;" tips="补发或者更换的理由"
										valid="required" errmsg="补发或者更换的理由不能为空!" length="200"
										onmousemove="show_tips(this, event,350)"
...
function setPeopleValue(str)
{
  ...
  <TR>
    ...
    <B>申请人信息</B>
      ...
      <INPUT onmousemove="show_tips(this, event,150)" onmouseout="hidden_tips()" onclick="addRow('sqr');sqr_show();"  value=增加申请人 type=button tips="当申请人为多个申请人时，点击该按钮进行增加，只添加该申请人的姓名或单位名称和电话" /> 
...
<TABLE align=center style="background-color:#fff;">
  ...
  <TR>
   ...
   <input type="button" value="保存" id="saveId" 
			 class="m_button" onClick="saveForm('${pageContext.request.contextPath}/application/z64/save');"/>
    </TD>
    <TD width=50>
    <input type="button" value="提交" id="subId" class="m_button" onClick="subForm('${pageContext.request.contextPath}/application/z64/submit');"/>
    </TD>
   <td>
