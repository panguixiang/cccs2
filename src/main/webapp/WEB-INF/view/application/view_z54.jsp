...
border=0 cellSpacing=0 cellPadding=0 width="100%" align=center>
  ...
  <TR>
    ...
    ?>
      <DIV class=title>注销著作权质权登记申请表</DIV></TD></TR></TBODY></TABLE>
  ...
  <TR>
    ...
    <TD>
      ...
      height="100%">
        ...
        <TR>
          <TH noWrap>质权登记号</TH>
          <TD class=InputTd><c:out value='${z54.originalRegNumber}' /></TD>
          <TH noWrap>登记日期</TH>
          <TD class=InputTd><c:out value='${z54.applyingType}' /></TD></TR>
        <TR>
          <TH noWrap>涉及作品名称</TH>
          <TD class=InputTd colSpan=3><c:out value='${z54.reason}' /></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD colSpan=2>
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void 
      height="100%">
        <TBODY>
        <TR>
          <TH width=100 noWrap>申请注销理由</TH>
          <TD class=InputTd><c:out value='${z54.softFullName}' /></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
      ...
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR>
          ...
          <TD style="WIDTH: 530px" class=InputTd>
		    <c:if test="${z54.applyType=='出质人办理'}">⊙</c:if>
			<c:if test="${z54.applyType!='出质人办理'}">○</c:if>出质人办理&nbsp;
			<c:if test="${z54.applyType=='质权人办理'}">⊙</c:if>
			<c:if test="${z54.applyType!='质权人办理'}">○</c:if>质权人办理&nbsp;
			<c:if test="${z54.isAgent=='代理人'}">
            <SPAN 
      ...
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR height=80>
          <TD style="WIDTH: 630px" class=InputTd colSpan=4>
            ...
            id=agentDescU>${z54.agent_desc}</U> </DIV></TD></TR>
        <TR height=50>
          <TH style="WIDTH: 100px">姓名或名称</TH>
...
<TABLE border=2 cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    <TH>证明文件</TH>
    <TD class=InputTd>
      <DIV style="FLOAT: left">1、注销协议</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">2、著作权质权登记证书原件</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">3、著作权质权登记证书复印件</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">4、授权委托文件</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      ...
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">9、查询结果</DIV>
