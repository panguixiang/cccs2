...
<body>
					...
					<table width="100%" align="center" border="1" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								...
								<td><input name="contract_type" value="转让合同" checked="checked"
										...
										<table width="100%" border="1" cellpadding="0" cellspacing="0"
											...
											<tbody>
												<tr>
													...
													<td width="50">类别</td>
													<td
														tips="在下拉菜单中选择：&nbsp;&lt;br&gt;1、公民：包括中国公民，作品作者所属国或者经常居住地国同中国签订有协议或共同参加的外国人、无国籍人，或者作品首先在中国境内出版的外国人、无国籍人。&nbsp;&lt;br&gt;2、法人：包括企业法人，指获得法人资格的企业；机关法人，指获得法人资格的国家机关；事业单位法人，指获得法人资格的事业单位；社会团体法人，指获得法人资格的社会团体。&nbsp;&lt;br&gt;3、其他组织：是指经登记并领取营业执照或社会团体登记证，但不具有法人资格的组织。包括：&nbsp;&lt;br&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;个人合伙组织&nbsp;&lt;br&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;法人合伙组织&nbsp;&lt;br&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;法人的分支机构&nbsp;
														&lt;br&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;个人独资企业&nbsp;&lt;br&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;中外合作经营企业&nbsp;&lt;br&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;外资企业&nbsp;&lt;br&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;筹建中的法人"
														onmousemove="show_tips(this,event,350)"
														onmouseout="hidden_tips()"><select name="peopleType1">
	...
	<tr>
		<td>地址</td>
		<td colspan="3"><input name="address1" value=""
...
<table width="100%" border="1" cellpadding="0" cellspacing="0"
	...
	<tr>
		<td>地址</td>
		<td colspan="3"><input name="address2" value=""
			style="width: 90%;" tips="请填写地址" valid="required"
			errmsg="地址不能为空！" length="200"
			onmousemove="show_tips(this,event,500)"
			onmouseout="hidden_tips()" maxlength="200">
							...
							<input name="right_scope" value="复制权"
									...
									onmouseout="hidden_tips()" type="checkbox">复制权 <input
										name="right_scope" value="发行权"
										tips="即以出售或者赠与方式向公众提供作品的原件或者复制件的权利。"
										onmousemove="show_tips(this,event,200)"
										onmouseout="hidden_tips()" type="checkbox">发行权 <input
											name="right_scope" value="出租权"
											tips="即有偿许可他人临时使用电影作品和以类似摄制电影的方法创作的作品的权利。"
											onmousemove="show_tips(this,event,200)"
											onmouseout="hidden_tips()" type="checkbox">出租权 <input
												name="right_scope" value="展览权"
												tips="即公开陈列美术作品、摄影作品的原件或者复制件的权利。"
												onmousemove="show_tips(this,event,200)"
												onmouseout="hidden_tips()" type="checkbox">展览权 <input
													name="right_scope" value="表演权"
													tips="即公开表演作品，以及用各种手段公开播送作品的表演的权利。"
													onmousemove="show_tips(this,event,200)"
													onmouseout="hidden_tips()" type="checkbox">表演权 <input
														name="right_scope" value="放映权"
														tips="即通过放映权、幻灯机等技术设备公开再现美术、摄影、电影和以类似摄制电影的方法创作的作品等的权利。"
														onmousemove="show_tips(this,event,200)"
														onmouseout="hidden_tips()" type="checkbox">放映权 <input
															name="right_scope" value="广播权"
															tips="即以无线方式公开广播或者传播作品，以有线传播或者转播的方式向公众传播广播的作品，以及通过扩音器或者其他传送符号、声音、图像的类似工具向公众传播广播的作品的权利。"
															onmousemove="show_tips(this,event,200)"
															onmouseout="hidden_tips()" type="checkbox">广播权 <br>
																	<input name="right_scope" value="信息网络传播权"
																	tips="即以有限或者无线方式向公众提供作品，使公众可以在某个人选定的时间和地点获得作品的权利"
																	onmousemove="show_tips(this,event,200)"
																	onmouseout="hidden_tips()" type="checkbox">信息网络传播权 <input name="right_scope" value="摄制权"
																		tips="即以摄制电影或者以类似摄制电影的方法将作品固定在载体上的权利。"
																		onmousemove="show_tips(this,event,200)"
																		onmouseout="hidden_tips()" type="checkbox">摄制权 <input name="right_scope" value="改编权"
																			tips="即改变作品，创作出具有独创性的新的作品的权利。"
																			onmousemove="show_tips(this,event,200)"
																			onmouseout="hidden_tips()" type="checkbox">改编权 <input name="right_scope" value="翻译权"
																				tips="即将作品从一种语言文字转换成另一种语言文字的权利。"
																				onmousemove="show_tips(this,event,200)"
																				onmouseout="hidden_tips()" type="checkbox">翻译权 <input name="right_scope" value="汇编权"
																					tips="即将作品或者作品的片段通过选择或者编排，汇集成新作品的权利。"
																					onmousemove="show_tips(this,event,200)"
																					onmouseout="hidden_tips()" type="checkbox">汇编权 <input name="right_scope" value="其他"
																						tips="应当由著作权人享有的其他权利。选择此项应进行说明，不超过100个汉字。"
																						onmousemove="show_tips(this,event,200)"
																						onmouseout="hidden_tips()" type="checkbox">其他 <br> 说明:<textarea id="rightDesc"
																									name="right_desc" cols="25" rows="2"
																									style="width: 500px;" tips="请填写权利范围说明"
																									length="200"
																									onmousemove="show_tips(this,event,500)"
																									onmouseout="hidden_tips()"></textarea>
								</td>
							...
							<tr>
								...
								<td title="填写合同中约定的地域范围，写明国家、城市或地区。">国家：<input
									name="appear_country" size="12" value="中国" tips="请填写国家"
									valid="required" errmsg="国家不能为空！" length="40"
									onmousemove="show_tips(this,event,350)"
									onmouseout="hidden_tips()" maxlength="40"> &nbsp;&nbsp;&nbsp;&nbsp;
										城市或地区：<input name="appear_city" size="12" value=""
...
<tr>
    ...
    <TD class=contentbg>
      <DIV style="FLOAT: left; OVERFLOW: auto">有效期自&nbsp; <INPUT type="text" 
      onmousemove="show_tips(this,event,350)"
      onmouseout=hidden_tips() onclick="fPopCalendar(this, this);" 
      name=valid_start_date value="" readOnly size=15 tips="请填写起始日期" errmsg="起始日期不能为空！" 
      valid="required"> </DIV>
      <DIV style="FLOAT: left" id="valid_end_dateid">&nbsp;&nbsp;&nbsp;&nbsp;有效期至&nbsp; 
      <INPUT type="text" onmousemove="show_tips(this,event,350)"
      onmouseout=hidden_tips() onclick="fPopCalendar(this, this);" 
      name=valid_end_date value="" id="valid_endId" readOnly size=15 tips="请填写截止日期" errmsg="截止日期不能为空！" 
      valid="required"> </DIV>
      <DIV style="FLOAT: left">&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <TD class=contentbg>
      <DIV style="FLOAT: left"><INPUT type="text" id=opus_nameid name=opus_name value="" size="50"
     ...
     onmousemove="show_tips(this,event,350)" onmouseout="hidden_tips()" maxlength="100"> </DIV>
      <DIV style="FLOAT: left">&nbsp;&nbsp;作品数量:&nbsp;<INPUT type="text" name=more_opus value=""
     onmousemove="show_tips(this,event,350)" onmouseout="hidden_tips()" size="10" maxlength="10"
      ...
      valid="required" />&nbsp;</DIV></TD></TR>
					...
					<input name="opus_type" value="文字"
											...
											onmouseout="hidden_tips()" type="checkbox">文字 <input
											name="opus_type" value="口述"
											tips="口述作品是指即兴的演说、授课、法庭辩论等以口头语言形式表现的作品"
											onmousemove="show_tips(this,event,170)"
											onmouseout="hidden_tips()" type="checkbox">口述 <input
												name="opus_type" value="音乐"
												tips="音乐作品是指歌曲、交响乐等能够演唱或者演奏的带词或者不带词的作品"
												onmousemove="show_tips(this,event,170)"
												onmouseout="hidden_tips()" type="checkbox">音乐 <input
													name="opus_type" value="戏剧" tips="戏剧作品是指话剧、歌剧、地方戏等供舞台演出的作品"
													onmousemove="show_tips(this,event,170)"
													onmouseout="hidden_tips()" type="checkbox">戏剧 <input
														name="opus_type" value="曲艺"
														tips="曲艺作品是指相声、快书、大鼓、评书等以说唱为主要形式表演的作品"
														onmousemove="show_tips(this,event,170)"
														onmouseout="hidden_tips()" type="checkbox">曲艺 <input
															name="opus_type" value="舞蹈"
															tips="舞蹈作品是指通过连续的动作、姿势、表情等表现思想情感的作品"
															onmousemove="show_tips(this,event,170)"
															onmouseout="hidden_tips()" type="checkbox">舞蹈 <input
																name="opus_type" value="杂技艺术"
																tips="杂技艺术作品是指杂技、魔术、马戏等通过形体动作和技巧表现的作品"
																onmousemove="show_tips(this,event,170)"
																onmouseout="hidden_tips()" type="checkbox">杂技艺术&nbsp;<input name="opus_type" value="美术"
																	tips="美术作品是指绘画、书法、雕塑等以线条、色彩或者其他方式构成的有审美意义的平面或者立体的造型艺术作品
                "
																	onmousemove="show_tips(this,event,170)"
																	onmouseout="hidden_tips()" type="checkbox">美术&nbsp;<input name="opus_type" value="建筑"
																		tips="建筑作品是指以建筑物或者构筑物形式表现的有审美意义的作品"
																		onmousemove="show_tips(this,event,170)"
																		onmouseout="hidden_tips()" type="checkbox">建筑&nbsp;<br /><input name="opus_type" value="摄影"
																			tips="摄影作品是指借助器械在感光材料或者其他介质上记录客观物体形象的艺术作品"
																			onmousemove="show_tips(this,event,170)"
																			onmouseout="hidden_tips()" type="checkbox">摄影 <input name="opus_type"
																				value="电影和类似摄制电影方法创作的作品"
                ...
                "
						onmousemove="show_tips(this,event,170)"
						onmouseout="hidden_tips()" type="checkbox">电影和类似摄制电影方法创作的作品 <input name="opus_type" value="图形"
							tips="图形作品是指为施工、生产绘制的工程设计图、产品设计图，以及反映地理现象、说明事物原理或者结构的地图、示意图等作品"
							onmousemove="show_tips(this,event,170)"
							onmouseout="hidden_tips()" type="checkbox">图形 <input name="opus_type" value="模型"
								tips="模型作品是指为展示、试验或者观测等用途，根据物体的形状和结构，按照一定比例制成的立体作品"
								onmousemove="show_tips(this,event,170)"
								onmouseout="hidden_tips()" type="checkbox">模型&nbsp;<INPUT
									onmousemove=show_tips(this,event,170)
									onmouseout=hidden_tips() name=opus_type
									value=录音制品 type=checkbox tips="录音制品">录音制品<br/><INPUT onmousemove=show_tips(this,event,170)
										onmouseout=hidden_tips() name=opus_type
										value=录像制品 type=checkbox tips="录像制品">录像制品&nbsp;<INPUT onmousemove=show_tips(this,event,170)
											onmouseout=hidden_tips() name=opus_type
											value=版式设计 type=checkbox tips="版式设计">版式设计&nbsp;<INPUT onmousemove=show_tips(this,event,170)
												onmouseout=hidden_tips() name=opus_type
												value=广播节目 type=checkbox tips="广播节目">广播节目&nbsp;<INPUT onmousemove=show_tips(this,event,170)
													onmouseout=hidden_tips() name=opus_type
													value=电视节目 type=checkbox tips="电视节目">电视节目&nbsp;<INPUT onmousemove=show_tips(this,event,170)
																		onmouseout=hidden_tips() name=opus_type
																		value=表演 type=checkbox tips="表演">表演&nbsp;<input name="opus_type" value="其他"
																tips="其他作品是指根据法律法规规定的其他作品。选择“其他”类时，请说明具体情况"
																onmousemove="show_tips(this,event,170)"
																onmouseout="hidden_tips()" type="checkbox">其他 
									</div>
							...
							<tr>
								...
								<td><input name="apply_type" value="由转让方或许可方申请" type="radio" checked />由转让方或许可方申请
									<input name="apply_type" value="由受让方或被许可方申请"  type="radio" />由受让方或被许可方申请
										 <input name="agent" value="ok"  onclick="s_h_agent(this)"
...
function setPeopleValue(str)
{
  ...
  <TR>
    <TD class="td_blue" colSpan=2>
      <DIV style="FLOAT: left"><B>提交者信息</B></DIV>
        ...
        <TR>
          ...
          class=contentbg>
            ...
            <DIV style="FLOAT: right"><INPUT onclick=deleteRow(this); value=删除 type=button>
									...
									<tr>
										<td>E-mail</td>
										<td><input id="sqremail" name="sqremail" value="" 
						...
						<tbody id="A-0" style="display: none;">
							...
							<tr>
								...
								<td><input id="dlrphone" name="dlrphone"
									title="格式如010-8888888" size="35" value="" tips="可选项，但如果要填写请按照正确的格式"
									onmousemove="show_tips(this,event,350)"
									onmouseout="hidden_tips()" maxlength="30">
								</td>
							</tr>
...
<TABLE align=center style="background-color:#fff;">
  ...
  <TR>
   ...
   <input type="button" value="保存" id="saveId" 
			 class="m_button" onClick="saveForm('${pageContext.request.contextPath}/application/z21/save');"/>
    </TD>
    <TD width=50>
    <input type="button" value="提交" id="subId" class="m_button" onClick="subForm('${pageContext.request.contextPath}/application/z21/submit');"/>
    </TD>
   <td>
