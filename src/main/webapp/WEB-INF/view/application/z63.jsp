						...
						<tbody>
							<tr>
								...
								<td><input class="inputtext" name="orig_admissible_num"
									length="40" tips="请填写登记受理号" onmousemove="show_tips(this, event,350)"
									onmouseout="hidden_tips()" type="text"  errmsg="登记受理号不能为空!" valid="required" />
								</td>
						...
						<tbody>
							...
							<tr>
								...
								<td><input id="sqrpostCode" name="sqrpostCode" size="35"
									value="" tips="请填写邮政编码" valid="required" 
...
<TABLE align=center style="background-color:#fff;">
  ...
  <TR>
   ...
   <input type="button" value="保存" id="saveId" 
			 class="m_button" onClick="saveForm('${pageContext.request.contextPath}/application/z63/save');"/>
    </TD>
    <TD width=50>
    <input type="button" value="提交" id="subId" class="m_button" 
    onClick="subForm('${pageContext.request.contextPath}/application/z63/submit');"/>
    </TD>
   <td>
