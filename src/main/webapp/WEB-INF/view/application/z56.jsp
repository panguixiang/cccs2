...
<title>在线填报-转让著作权质权登记事项申请表</title>
...
border=0 cellSpacing=0 cellPadding=0 width="80%" align=center>
  ...
  <TR>
    <TD class="contentbg small_title" colSpan=2><SPAN 
      class=datacell>质权基本信息</SPAN></TD></TR>
  <TR>
    ...
    <TD class=contentbg><INPUT 
      ...
      errmsg="质权登记号不能为空!" valid="required" value="<c:out value='${z56.originalRegNumber}' />" /> </TD></TR>
  <TR>
    <TD class=contentbg><SPAN class=datacell>质权登记日期</SPAN></TD>
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() onclick="fPopCalendar(this, this);" 
      name=applyingType readOnly tips="请填写登记日期" errmsg="登记日期不能为空!" 
      valid="required" value="<c:out value='${z56.applyingType}' />" /> </TD></TR>
  <TR>
    ...
    <TD class=contentbg><INPUT style="WIDTH: 448px" id=opusName 
      ...
      length="200" errmsg="作品名称不能为空!" valid="required" value="<c:out value='${z56.reason}' />" /> </TD></TR>
  <TR>
    ...
    id=personData class=contentbg colSpan=2>
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          name=legalPeople1 size=15 tips="请填写法定代表人" length="100" errmsg="法定代表人不能为空!" valid="required" disabled /> 
          </TD></TR>
        <TR>
          <TD 
        ...
        <TR>
          ...
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px">电话</TD>
          <TD 
    ...
    id=personData1 class=contentbg colSpan=2>
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          name=legalPeople2 size=15 tips="请填写法定代表人" length="100" errmsg="法定代表人不能为空!" valid="required" disabled/> 
          </TD></TR>
        <TR>
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
        ...
        <TR>
          ...
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><SELECT 
            style="WIDTH: 115px" name=impawnType2> <OPTION selected 
              value=债务人>债务人</OPTION> <OPTION value=第三方>第三方</OPTION></SELECT> </TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px">电话 
          </TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px">
          <INPUT id=test onmousemove=cpcc_showtip(this.tips,this.valid,this.length,200) onmouseout=cpcc_showtip() 
          name=legalPeople2 size=15 tips="请填写法定代表人" length="100" errmsg="法定代表人不能为空!" valid="required" disabled/> 
          </TD></TR>
        <TR>
          <TD 
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
         ...
         <TD>出质人类型</TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px">
          <SELECT style="WIDTH: 115px" name=impawnType2> 
           <OPTION value=债务人 <c:if test="${cp2.busType=='债务人'}">selected</c:if>>债务人</OPTION>
             <OPTION value=第三方 <c:if test="${cp2.busType=='第三方'}">selected</c:if>>第三方</OPTION>
         </SELECT> </TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px">电话 
          </TD>
      ...
      <TR>
    <TD class="contentbg small_title" colSpan=2>
      <DIV style="FLOAT: left">受让人信息</DIV>
      <DIV style="FLOAT: right">
      <INPUT style="WIDTH: 80px" onclick="addRow('personData2')" name=button value=增加受让人 type=button /> 
      </DIV></TD></TR>
  <TR>
    <TD 
    style="PADDING-BOTTOM: 0px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; PADDING-TOP: 0px" 
    id=personData2 class=contentbg colSpan=2>
      <DIV style="DISPLAY: none">
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          ...
          width=150>姓名或单位名称</TD>
          <TD width=80>类别</TD>
          <TD><SELECT onchange=s_h_legalPeople(this) name=peopleType3> 
              <OPTION selected 
              value=自然人>自然人</OPTION> <OPTGROUP label=法人> <OPTION 
                value=企业法人>企业法人</OPTION> <OPTION value=机关法人>机关法人</OPTION> <OPTION 
                value=事业单位法人>事业单位法人</OPTION> <OPTION value=社会团体法人>社会团体法人</OPTION> 
          ...
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px">
          <INPUT onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() 
          name=legalPeople3 size=15 tips="请填写法定代表人" length="100" errmsg="法定代表人不能为空!" valid="required" disabled/> 
          </TD></TR>
        <TR>
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
          rowSpan=4><TEXTAREA style="TEXT-ALIGN: left; WIDTH: 150px; HEIGHT: 110px; OVERFLOW: hidden" 
          onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() rows=4 name=name3 
          tips="请填写姓名或单位名称" length="200" errmsg="姓名或单位名称不能为空!" valid="required"></TEXTAREA></TD>
          <TD>证件类型</TD>
          <TD><SELECT name=idTypes3> <OPTION selected value=居民身份证>居民身份证</OPTION> 
              <OPTION value=军官证>军官证</OPTION> <OPTION value=护照>护照</OPTION> <OPTION 
              value=企业法人营业执照>企业法人营业执照</OPTION> <OPTION value=组织机构代码证书>组织机构代码证书</OPTION> 
              <OPTION value=事业单位法人证书>事业单位法人证书</OPTION> <OPTION value=社团法人证书>社团法人证书</OPTION> 
              <OPTION value=营业执照>营业执照</OPTION> <OPTION value=其他有效证件>其他有效证件</OPTION></SELECT> </TD>
          ...
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=idNumber3 maxLength=40 size=15 
            tips="请填写证件号码" length="40" errmsg="证件号码不能为空!" valid="required" /> 
        </TD></TR>
        <TR>
          <TD>出质人类型</TD>
          <TD><SELECT style="WIDTH: 115px" name=impawnType3> <OPTION 
          ...
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=phone3 size=15 
            tips="可选项，但如果要填写请按照正确的格式" length="40" /> </TD></TR>
        <TR>
          <TD>联系人</TD>
          <TD><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=contactPerson3 size=15 tips="请填写联系人" 
            length="40" errmsg="联系人不能为空!" valid="required" /> </TD>
          <TD>邮政编码</TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=postCode3 size=15 tips="请填写邮政编码" 
            length="6" errmsg="不能为空！|格式为6位数字" valid="required|isZip" /> </TD></TR>
        <TR>
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 1px">地址</TD>
          ...
          colSpan=3>
            <DIV style="FLOAT: left"><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=address3 size=50 tips="请填写地址" 
            length="100" errmsg="地址不能为空!" valid="required" /> </DIV>
            <DIV style="FLOAT: right">
            <INPUT onclick=deleteRow(this); value=删除 type=button /></DIV></TD></TR></TBODY></TABLE></DIV>
            <c:choose>
            <c:when test="${empty cps3}">
            <DIV>
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          ...
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><SELECT 
            onchange=s_h_legalPeople(this) name=peopleType3>  <OPTION selected 
              value=自然人>自然人</OPTION> <OPTGROUP label=法人> <OPTION 
                value=企业法人>企业法人</OPTION> <OPTION value=机关法人>机关法人</OPTION> <OPTION 
                value=事业单位法人>事业单位法人</OPTION> <OPTION value=社会团体法人>社会团体法人</OPTION> 
              </OPTGROUP> <OPTION value=其他组织>其他组织</OPTION> <OPTION 
        ...
        <TR>
          ...
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,200) 
            onmouseout=cpcc_showtip() name=idNumber3 size=15 tips="请填写证件号码" 
            length="40" errmsg="证件号码不能为空!" valid="required" /> </TD></TR>
        <TR>
          <TD>出质人类型</TD>
          <TD><SELECT style="WIDTH: 115px" name=impawnType3> <OPTION 
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          <TD width=80>类别</TD>
          <TD><SELECT onchange=s_h_legalPeople(this) name=peopleType3> 
              <OPTION value=自然人 <c:if test="${cp3.people_type=='自然人'}">selected</c:if>>自然人</OPTION>
            <OPTGROUP label=法人>
            <OPTION value=企业法人 <c:if test="${cp3.people_type=='企业法人'}">selected</c:if>>企业法人</OPTION>
            <OPTION value=机关法人 <c:if test="${cp3.people_type=='机关法人'}">selected</c:if>>机关法人</OPTION>
            <OPTION value=事业单位法人 <c:if test="${cp3.people_type=='事业单位法人'}">selected</c:if>>事业单位法人</OPTION>
            <OPTION value=社会团体法人 <c:if test="${cp3.people_type=='社会团体法人'}">selected</c:if>>社会团体法人</OPTION> 
           </OPTGROUP>
           <OPTION value=其他组织 <c:if test="${cp3.people_type=='其他组织'}">selected</c:if>>其他组织</OPTION>
           <OPTION value=其他 <c:if test="${cp3.people_type=='其他'}">selected</c:if>>其他</OPTION></SELECT> </TD>
          <TD width=80>法定代表人</TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px">
          <INPUT onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() 
          name=legalPeople3 size=15 tips="请填写法定代表人" length="100" errmsg="法定代表人不能为空!" valid="required"
           value="<c:out value='${cp3.hasLetter}' />" <c:if test="${cp3.people_type=='自然人'}">disabled</c:if> /> 
          </TD></TR>
        <TR>
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
          rowSpan=4><TEXTAREA style="TEXT-ALIGN: left; WIDTH: 150px; HEIGHT: 110px; OVERFLOW: hidden" 
          onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() rows=4 name=name3 
          tips="请填写姓名或单位名称" length="200" errmsg="姓名或单位名称不能为空!" valid="required"><c:out value="${cp3.name}" /></TEXTAREA></TD>
          <TD>证件类型</TD>
          <TD><SELECT name=idTypes3>
           <OPTION value=居民身份证 <c:if test="${cp3.id_type=='居民身份证'}">selected</c:if>>居民身份证</OPTION>
           <OPTION value=军官证 <c:if test="${cp3.id_type=='军官证'}">selected</c:if>>军官证</OPTION>
           <OPTION value=护照 <c:if test="${cp3.id_type=='护照'}">selected</c:if>>护照</OPTION>
           <OPTION value=企业法人营业执照 <c:if test="${cp3.id_type=='企业法人营业执照'}">selected</c:if>>企业法人营业执照</OPTION>
           <OPTION value=组织机构代码证书 <c:if test="${cp3.id_type=='组织机构代码证书'}">selected</c:if>>组织机构代码证书</OPTION> 
           <OPTION value=事业单位法人证书 <c:if test="${cp3.id_type=='事业单位法人证书'}">selected</c:if>>事业单位法人证书</OPTION>
           <OPTION value=社团法人证书 <c:if test="${cp3.id_type=='社团法人证书'}">selected</c:if>>社团法人证书</OPTION> 
           <OPTION value=营业执照 <c:if test="${cp3.id_type=='营业执照'}">selected</c:if>>营业执照</OPTION>
           <OPTION value=其他有效证件 <c:if test="${cp3.id_type=='其他有效证件'}">selected</c:if>>其他有效证件</OPTION>
           </SELECT> </TD>
          <TD>证件号码</TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=idNumber3 maxLength=40 size=15 
            tips="请填写证件号码" length="40" errmsg="证件号码不能为空!" valid="required" value="<c:out value='${cp3.id_number}' />" /> 
        </TD></TR>
        <TR>
          <TD>出质人类型</TD>
          <TD><SELECT style="WIDTH: 115px" name=impawnType3>
             <OPTION value=债务人 <c:if test="${cp3.busType=='债务人'}">selected</c:if>>债务人</OPTION>
             <OPTION value=第三方 <c:if test="${cp3.busType=='第三方'}">selected</c:if>>第三方</OPTION>
            </SELECT> </TD>
          <TD>电话</TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=phone3 size=15 
            tips="可选项，但如果要填写请按照正确的格式" length="40" value="<c:out value='${cp3.sign}' />" /> </TD></TR>
        <TR>
          <TD>联系人</TD>
          <TD><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=contactPerson3 size=15 tips="请填写联系人" 
            length="40" errmsg="联系人不能为空!" valid="required" value="<c:out value='${cp3.opus_sign}' />" /> </TD>
          <TD>邮政编码</TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=postCode3 size=15 tips="请填写邮政编码" 
            length="6" errmsg="不能为空！|格式为6位数字" valid="required|isZip" value="<c:out value='${cp3.garden}' />" /> </TD></TR>
        <TR>
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 1px">地址</TD>
          <TD 
          ...
          colSpan=3>
            ...
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() name=address3 size=50 tips="请填写地址" 
            length="100" errmsg="地址不能为空!" valid="required" value="<c:out value='${cp3.addr}' />"/> </DIV>
            <DIV style="FLOAT: right">
            <INPUT onclick=deleteRow(this); value=删除 type=button /></DIV></TD></TR></TBODY></TABLE></DIV>
            </c:otherwise>
            </c:choose>
       ...
       <TR>
    <TD class="contentbg small_title" colSpan=2>转让合同主要内容</TD></TR>
    <c:choose>
    <c:when test="${empty infos}">
     <TR>
    <TD class=contentbg>原质权担保期限</TD>
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name=bailDateInfo size=50 
      tips="原质权担保期限，应与原质权登记证书内容一致，如文字描述，则填写文字描述内容；如有具体期限，则填写从 年 月 日  到 年 月 日。" 
      errmsg="原质权担保期限不能为空!" valid="required"  /> </TD></TR>
  <TR>
    <TD class=contentbg>转让著作权种类</TD>
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name=copyrightType size=50 
      tips="转让著作权种类，应与原质权登记证书内容一致。" length="100" errmsg="转让著作权种类不能为空!" 
      valid="required" /></TD></TR>
  <TR>
    <TD class=contentbg>转让质权范围</TD>
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name=copyrightScope size=50 
      tips="转让质权范围，应与原著作权质权登记证书内容一致" length="100" errmsg="转让质权范围不能为空!" 
      valid="required" /></TD></TR>
    </c:when>
    <c:otherwise>
    ...
    <TD class=contentbg><INPUT 
      ...
      onmouseout=cpcc_showtip() name=bailDateInfo size=50 
      tips="原质权担保期限，应与原质权登记证书内容一致，如文字描述，则填写文字描述内容；如有具体期限，则填写从 年 月 日  到 年 月 日。" 
      errmsg="原质权担保期限不能为空!" valid="required" value="<c:out value='${info.item}' />" /> </TD></TR>
  <TR>
    <TD class=contentbg>转让著作权种类</TD>
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name=copyrightType size=50 
      tips="转让著作权种类，应与原质权登记证书内容一致。" length="100" errmsg="转让著作权种类不能为空!" 
      valid="required" value="<c:out value='${info.before_content}' />" /></TD></TR>
  <TR>
    <TD class=contentbg>转让质权范围</TD>
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() name=copyrightScope size=50 
      tips="转让质权范围，应与原著作权质权登记证书内容一致" length="100" errmsg="转让质权范围不能为空!" 
      valid="required" value="<c:out value='${info.after_content}' />" /></TD></TR>
      </c:forEach>
    </c:otherwise>
    </c:choose>
  ...
  <TR>
    ...
    <TD class=contentbg>
     <c:choose>
    <c:when test="${empty z56}">
   <INPUT id=applyType name=applyType value=受让人申请 CHECKED 
      type=radio />受让人申请
       <INPUT id=applyType name=applyType value=转让人申请 
      type=radio />转让人申请
     <INPUT onclick=s_h_agent(this) name=isAgent value=代理人 
      type=checkbox />由代理人申请
    </c:when>
    <c:otherwise>
   <INPUT id=applyType name=applyType value=受让人申请 
      type=radio <c:if test="${z56.applyType=='受让人申请'}">CHECKED</c:if> />受让人申请
    <INPUT id=applyType name=applyType value=转让人申请 
      type=radio <c:if test="${z56.applyType=='转让人申请'}">CHECKED</c:if> />转让人申请   
  <INPUT onclick=s_h_agent(this) name=isAgent value=代理人 type=checkbox 
  <c:if test="${z56.isAgent=='代理人'}">CHECKED</c:if> />由代理人申请
    </c:otherwise>
    </c:choose>
    </TD></TR>
  <SCRIPT>
  ...
  <TR>
    <TD class=contentbg 
      ...
      valid="required" value="<c:out value='${z56.agent_desc}' />" /> </TD></TR>
  <TR>
    <TD class=contentbg>姓名或名称</TD>
...
<TABLE align=center style="background-color:#fff;">
  ...
  <TR>
   ...
   <input type="button" value="保存" id="saveId" 
			 class="m_button" onClick="onlySaveForm('${pageContext.request.contextPath}/application/z53and6/save/z56');"/>
    </TD>
    <TD width=50 style="padding-right:15px;">
    <input type="button" value="提交" id="subId" class="m_button" 
    onClick="subForm('${pageContext.request.contextPath}/application/z53and6/submit/z56');"/>
    </TD>
   <td>
	...
	function beforeValid()
	{
		...
		setIsValid('peopleType3','legalPeople3','自然人');
	}
	...
	function lastLogic()
	{
		...
		setLegalPeopleValue('peopleType3','legalPeople3');
	}
