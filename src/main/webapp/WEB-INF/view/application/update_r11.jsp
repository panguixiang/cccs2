...
<input type="hidden" name="flow_num" value="${r11.flow_num}" />
...
border=0 cellSpacing=0 cellPadding=0 width="80%" align=center>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT style="WIDTH: 448px" id="softFullNameid" 
      ...
      length="200" errmsg="软件全称不能为空!" valid="required" value="<c:out value='${r11.softFullName} ' />" /></TD></TR>
  <TR>
    ...
    <TD class=contentbg>
      ...
      tips="对登记软件全称进行简化的名称。如：DOS、Windows、WPS等；（没有简称可以不填此栏）"
       length="100" value="<c:out value='${r11.softForShort} ' />" /> </DIV>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT id="softNumberid" 
      ...
      tips="在表中提供的原国家标准GB/T13702和国家标准GB/4754-2002中的代码确定的分类编号选择填写,且不支持IE8请选择IE7或较低版本；" 
       errmsg="分类号不能为空!" valid="required" value="<c:out value='${r11.softNumber} ' />" /> 
<INPUT onclick=windowOpen_SoftNumber(); value=选择分类号 type=button> </TD></TR>
  <TR>
    ...
    <TD class=contentbg><INPUT id="editionNumberid" 
      ...
      errmsg="版本号不能为空!" valid="required"  value="<c:out value='${r11.editionNumber} ' />" /> </TD></TR>
  <TR>
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          colSpan=2><INPUT 
            ...
            value="1" type="radio" tips="" <c:if test="${r11.developCircs=='1'}">checked="checked"</c:if> />原创 <INPUT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
            onmouseout=cpcc_showtip() 
            onclick="showOrHideDevelopCircs(this,'s');" name="developCircs" 
            value="2" type="radio" 
            tips="在原有软件基础上修改后，形成的在功能或性能方面有重要改进的软件。" <c:if test="${r11.developCircs=='2'}">checked="checked"</c:if>>修改(含翻译软件、合成软件) </TD></TR>
        ...
        <TR>
          ...
          colSpan=2><INPUT id="developCircsExplainid" name="developCircsExplain" 
            value="0" type="checkbox" <c:if test="${r11.developCircsExplain=='0'}">checked="checked"</c:if> />是修改、翻译或合成别人软件，且需要原权利人授权的</TD></TR>
        <TR>
          <TD 
          ...
          colSpan=2><INPUT id="origSoftRegCircsid" 
            ...
            value="0" type="checkbox" <c:if test="${r11.origSoftRegCircs=='0'}">checked="checked"</c:if> />原有软件已经登记</TD></TR>
            </TBODY>
        ...
        <TR>
          ...
          width="80%"><INPUT id="origRegisterNumberid" onmousemove=cpcc_showtip(this.tips,this.valid,this.length,500) 
            ...
            tips="请填写原登记号" length="50" errmsg="原登记号不能为空!" valid="required" value="<c:out value='${r11.origRegisterNumber}' />" /> 
        </TD></TR></TBODY>
        ...
        <TR>
          ...
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px;BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 1px">
           ...
           onmouseout=cpcc_showtip() cols=25 name="origSoftModifyDescription" tips="需要简明阐述软件新增加、删改的功能模块及程序的变化；&nbsp;<br>翻译软件简明阐述由一种计算机语言转换成另一种计算机语言表达的说明；&nbsp;
           <br>合成软件需要简明阐述合成或汇编的已有软件或程序，并对其取得著作权的材料及所编入的材料进行概括性描述；&nbsp;申请软件属于修改软件的，请简短明确阐述修改软件“新增功能模块”或“程序的第10～100行”、“全部翻译文本”等。对翻译或合成软件应对其取得著作权的材料及所编入的材料进行概括性描述。说明字数限于100字之内。若原有软件已经进行登记的，应注明原有软件著作权登记号。&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" length="400" errmsg="修改合成或翻译说明说明不能为空!" valid="required">
           <c:out value="${r11.origSoftModifyDescription}" /></TEXTAREA> 
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT id="completeDate" 
      ...
      errmsg="开发完成日期不能为空!" valid="required" value="<c:out value='${r11.completeDate}' />"  /></TD></TR>
  <TR>
    <TD class=contentbg>发表状态</TD>
    <TD class=contentbg>
      <DIV style="FLOAT: left"><INPUT id="publishStatusid" onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() onclick=showOrHide() name="publishStatus" value="1" 
       type=radio tips="软件已发表的，请选择已发表选项，并填写首次发表日期和首次发表地点所在的国家或城市" <c:if test="${r11.publishStatus=='1'}">checked="checked"</c:if> /> 已发表 
      <INPUT id="publishStatusid" 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() onclick=showOrHide() name="publishStatus" value="0" 
      type="radio" tips="软件未发表的，请选择未发表选项，并选择填写是允许公众查阅该申请登记软件的鉴别材料。"
       <c:if test="${r11.publishStatus=='0'}">checked="checked"</c:if> /> 未发表 </DIV></TD></TR>
  <TBODY id="pubstate">
  <TR>
    ...
    <TD class=contentbg>首次发表日期：<INPUT 
      ...
      name="appearDate"  readOnly size=12 tips="请填写首次发表日期" errmsg="首次发表日期不能为空！" 
      valid="required" value="<c:out value='${r11.appearDate}' />" /> </TD></TR>
  <TR>
    <TD class=contentbg>首次发表地点 国家：<INPUT 
      ...
      tips="请填写国家" length="40" errmsg="国家不能为空！" valid="required" value="<c:out value='${r11.appearAreaCountry}' />" /> 
      ...
      length="40" errmsg="城市不能为空！" valid="required" value="<c:out value='${r11.appearAreaCity} ' />"  /> </TD></TR>
      </TBODY>
  <TBODY>
  <TR>
    ...
    <TD class=contentbg><INPUT id="developModeid" 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,300) 
      onmouseout=cpcc_showtip() name="developMode" value="1" type="radio" 
      tips="指依靠自身的条件自行开发完成的软件。" <c:if test="${r11.developMode=='1'}">checked="checked"</c:if> /> 独立开发 
      <INPUT id="developModeid" onmousemove=cpcc_showtip(this.tips,this.valid,this.length,300) 
      onmouseout=cpcc_showtip() name="developMode" value="2" type="radio" 
      tips="指两人或两人以上依据合作协议共同开发完成的软件。需要提供的证明文件：证明申请人享有权利合作开发协议&#13;&#10;" 
      <c:if test="${r11.developMode=='2'}">checked="checked"</c:if> /> 合作开发 
      ...
      tips="指委托人与被委托人之间依据委托协议开发完成的软件。需要提供的证明文件：证明申请人享有著作权的委托协议&#13;&#10;"
       <c:if test="${r11.developMode=='3'}">checked="checked"</c:if> /> 委托开发 
      <INPUT id="developModeid" 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,300) 
      onmouseout=cpcc_showtip() name="developMode" value="4" type="radio" 
      tips="指由国家下达任务开发的软件。应提交项目任务书或合同。无项目任务书或合同，应提交相关证明。"
       <c:if test="${r11.developMode=='4'}">checked="checked"</c:if> /> 下达任务开发 </TD></TR>
  <TR>
    <TD class=contentbg>权利取得方式</TD>
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,300) 
      onmouseout=cpcc_showtip() onclick="setDefaultCheck(this,'m')" 
      name="rightObtainMode" value="1" type="radio" tips="自然人、法人或其他组织对其所开发完成的软件依法享有著作权。"
       <c:if test="${r11.rightObtainMode=='1'}">checked="checked"</c:if> />原始取得<BR><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,300) 
      onmouseout=cpcc_showtip() onclick="setDefaultCheck(this,'m')" 
      name="rightObtainMode" value="2" type="radio" tips="包括受让、承受、继承取得著作权的方式。"
        <c:if test="${r11.rightObtainMode=='2'}">checked="checked"</c:if> />继受取得 ( 
      <INPUT onmousemove=cpcc_showtip(this.tips,this.valid,this.length,300) 
       onmouseout=cpcc_showtip() name="inheritanceMode" value="22" 
      type="radio" tips="是指著作权人将著作权中的全部或部分财产权有偿或无偿地移交给他人所有的法律行为。需要提供的证明文件为著作权转让合同。"
        <c:if test="${r11.inheritanceMode=='22'}">checked="checked"</c:if> />受让 <INPUT 
      ...
      tips="是指享有原著作权的企业被合并或分立，由合并或分立后其他企业享有著作权情况。需要提供的证明文件是企业变更证明及其他证明（合同、债权人会议决定和清算组织公告等）。"
       <c:if test="${r11.inheritanceMode=='23'}">checked="checked"</c:if> />承受 
      <INPUT onmousemove=cpcc_showtip(this.tips,this.valid,this.length,300) 
      disabled onmouseout=cpcc_showtip() name=inheritanceMode value="21" 
      type="radio" 
      tips="指根据继承法继承人继承被继承人的著作权中财产权利。需要提供的证明文件是被继承人的死亡证明、被继承人有效遗嘱、与被继承人的关系证明、继承人身份证明、法院的法律文书。"
       <c:if test="${r11.inheritanceMode=='21'}">checked="checked"</c:if> />继承 
      )<BR>&nbsp;&nbsp;<INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,300); disabled 
      onmouseout=cpcc_showtip() onclick=isCheck(this) name="isSoftReg" value="0" 
      type="checkbox" tips="若软件已登记，则可不填写软件技术特点相关内容" 
      <c:if test="${r11.isSoftReg=='0'}">checked="checked"</c:if> />软件是否已登记 （原登记号：<INPUT 
      id="regNumberid" 
      ...
      length="30" value="<c:out value='${r11.regNumber}' />" /> ）<BR>&nbsp;
      <INPUT disabled name="isSoftChanged" value="0" 
      type="checkbox" <c:if test="${r11.isSoftChanged=='0'}"></c:if> />原登记是否做过变更或补充 （变更或补充证明编号：<INPUT id="changeNumberid" 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,500) disabled 
      onmouseout=cpcc_showtip() name="changeNumber" 
      tips="若原登记做过变更或补充，请填写变更或补充证明书编号" length="150" value="<c:out value='${r11.changeNumber}' />" />） </TD></TR>
  <TR>
    <TD class=contentbg>权利范围</TD>
    <TD class=contentbg>
      <DIV><INPUT onclick=s_h_item(this); name="rightScope" value="1" <c:if test="${r11.rightScope=='1'}">checked="checked"</c:if>  
      type="radio" />全部<BR><INPUT onclick=s_h_item(this); name="rightScope" value="2"
      type="radio" <c:if test="${r11.rightScope=='2'}">checked="checked"</c:if> />部分 <BR>&nbsp;&nbsp; 
      <c:choose>
      <c:when test="${发表权=='发表权'}">
      <INPUT  name="rightScope_" value="发表权" type="checkbox" checked=="checked" />发表权 
      </c:when>
      <c:otherwise>
      <INPUT  name="rightScope_" value="发表权" type="checkbox" />发表权 
      </c:otherwise>
      </c:choose>
      <c:choose>
      <c:when test="${署名权=='署名权'}">
       <INPUT  name="rightScope_" value="署名权" type="checkbox" checked=="checked" />署名权
      </c:when>
      <c:otherwise>
      <INPUT  name="rightScope_" value="署名权" type="checkbox" />署名权
      </c:otherwise>
      </c:choose>
      <c:choose>
      <c:when test="${修改权=='修改权'}">
      <INPUT  name="rightScope_" value="修改权" type="checkbox" checked=="checked" />修改权
      </c:when>
      <c:otherwise>
      <INPUT  name="rightScope_" value="修改权" type="checkbox" />修改权
      </c:otherwise>
      </c:choose>
      <c:choose>
      <c:when test="${复制权=='复制权'}">
      <INPUT  name="rightScope_" value="复制权" type="checkbox" checked=="checked" />复制权
      </c:when>
      <c:otherwise>
      <INPUT  name="rightScope_" value="复制权" type="checkbox" />复制权
      </c:otherwise>
      </c:choose>
      <c:choose>
      <c:when test="${发行权=='发行权'}">
      <INPUT  name="rightScope_" value="发行权" type="checkbox" checked=="checked" />发行权 
      </c:when>
      <c:otherwise>
        <INPUT  name="rightScope_" value="发行权" type="checkbox" />发行权 
      </c:otherwise>
      </c:choose>
     <BR>&nbsp;&nbsp; 
       <c:choose>
      <c:when test="${出租权=='出租权'}">
       <INPUT  name="rightScope_" value="出租权" type="checkbox" checked=="checked" />出租权 
      </c:when>
      <c:otherwise>
       <INPUT  name="rightScope_" value="出租权" type="checkbox" />出租权 
      </c:otherwise>
      </c:choose>
        <c:choose>
      <c:when test="${信息网络传播权=='信息网络传播权'}">
      <INPUT  name="rightScope_" value="信息网络传播权" type="checkbox" checked=="checked" />信息网络传播权 
      </c:when>
      <c:otherwise>
      <INPUT  name="rightScope_" value="信息网络传播权" type="checkbox" />信息网络传播权 
      </c:otherwise>
      </c:choose>
        <c:choose>
      <c:when test="${翻译权=='翻译权'}">
     <INPUT  name="rightScope_" value="翻译权" type="checkbox" checked=="checked" />翻译权
      </c:when>
      <c:otherwise>
       <INPUT  name="rightScope_" value="翻译权" type="checkbox" />翻译权
      </c:otherwise>
      </c:choose>
        <c:choose>
      <c:when test="${应当由著作权人享有的其他权利=='应当由著作权人享有的其他权利'}">
       <INPUT  name="rightScope_" value="应当由著作权人享有的其他权利" type="checkbox" checked=="checked" />应当由著作权人享有的其他权利
      </c:when>
      <c:otherwise>
        <INPUT  name="rightScope_" value="应当由著作权人享有的其他权利" type="checkbox" />应当由著作权人享有的其他权利
      </c:otherwise>
      </c:choose>
      </TBODY>
      </DIV>
  ...
  <TR>
    ...
    onmouseout=cpcc_showtip() cols=45 rows=3 name="hardwareEnv" tips="指开发和运行登记软件的计算机硬件和专用设备。" length="255">
    <c:out value='${r11.hardwareEnv}' /></TEXTAREA></TD></TR>
  <TR>
    ...
    onmouseout=cpcc_showtip() cols=45 rows=3 name="softwareEnv" tips="指开发和运行登记软件的操作系统、支持软件的名称及版本号。" length="255">
    <c:out value='${r11.softwareEnv}' /></TEXTAREA> 
    </TD></TR>
  <TR>
    ...
    <TD class=contentbg><INPUT style="WIDTH: 448px" id="programLanguageid" 
      ...
      errmsg="请填写编程语言!" valid="required" value="<c:out value='${r11.programLanguage}' />" /></TD></TR>
  <TR>
    ...
    valid="required" value="<c:out value='${r11.sourceCodeCapacity}' />" /></TD></TR>
  <TR>
    ...
    onmouseout=cpcc_showtip() cols=45 rows=5 name="softFunctionAndSpecialty" tips="简短明确阐述软件的创作目的、主要功能、用途和技术特点。说明字数限于500个汉字。" length="1000" errmsg="请填写主要功能和技术特点!" valid="required">
    <c:out value='${r11.softFunctionAndSpecialty}' /></TEXTAREA></TD></TR>
  <TR>
...
onclick="addRow('personData')" name="button" value="增加著作权人" type="button" tips="多个著作权人点这里添加"> 
        ...
        <TR>
          ...
          colSpan=3>
           ...
           <OPTION value="否">否</OPTION>
            ...
            <c:forEach items="${cps}" var="cp" varStatus="cpstats">
      <DIV>
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          ...
          tips="在下拉菜单中选择：&nbsp;<br>1.著作权人是自然人的，应填写真实姓名，需要提交的证明文件复印件包括身份证、&nbsp;<br>&nbsp;&nbsp;军官证、护照或其他身份证明；&nbsp;<br>2.著作权人是法人的，应填写名称、类别、国籍、省份、城市和园区。&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;企业法人，指获得法人资格的企业。&nbsp;需提交的文件为工商营业执照；&nbsp;<br>　&nbsp;&nbsp;机关法人，指获得法人资格的国家机关。需提交的文件为组织机构代码证书；&nbsp;<br>　&nbsp;&nbsp;事业单位法人，指获得法人资格的事业单位。需提交的文件为事业单位法人证书；&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;社会团体法人，指获得法人资格的社会团体。需提交的文件为社团法人证书；&nbsp;<br>3.其他组织：其他组织是指经登记并领取营业执照或社会团体登记证，但不具有法人资格的组织。&nbsp;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;法人的分支机构需提交的文件为营业执照或社会团体登记证，以及法人不主张著作权的证明。&nbsp;<br>4.其他：&nbsp;是指不属于上面三类人的人"><SELECT 
            ...
            name=peopleType1> 
             <OPTION value="自然人" <c:if test="${cp.people_type=='自然人'}">selected="selected"</c:if> >自然人</OPTION>
            <OPTGROUP label="法人"> 
                <OPTION <c:if test="${cp.people_type=='企业法人'}">selected="selected"</c:if> value="企业法人">企业法人</OPTION>
                <OPTION <c:if test="${cp.people_type=='机关法人'}">selected="selected"</c:if> value="机关法人">机关法人</OPTION> 
                <OPTION <c:if test="${cp.people_type=='事业单位法人'}">selected="selected"</c:if> value="事业单位法人">事业单位法人</OPTION>
                <OPTION <c:if test="${cp.people_type=='社会团体法人'}">selected="selected"</c:if> value="社会团体法人">社会团体法人</OPTION>
           </OPTGROUP>
           <OPTION <c:if test="${cp.people_type=='其他组织'}">selected="selected"</c:if> value="其他组织">其他组织</OPTION> 
           <OPTION <c:if test="${cp.people_type=='其他'}">selected="selected"</c:if> value="其他">其他</OPTION></SELECT> </TD>
          <TD 
        ...
        <TR>
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
          rowSpan=4><TEXTAREA style="TEXT-ALIGN: left; WIDTH: 110px; HEIGHT: 70px; OVERFLOW: hidden" onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) onmouseout=cpcc_showtip() rows=3 name="name1" tips="著作权人是自然人的，应填写真实姓名。&nbsp;<br>著作权人是法人或其他组织的，应填写名称。&nbsp;<br>姓名或名称应与身份证明文件一致。" length="100" errmsg="著作权人姓名或名称不能为空！" valid="required">${cp.name}</TEXTAREA></TD>
          <TD>省份</TD>
          <TD 
          ...
          <INPUT style="WIDTH: 200px" onmousemove=cpcc_showtip(this.tips,this.valid,this.length,150) 
            onmouseout=cpcc_showtip() name="city1" maxLength=100 size=15 
            tips="请填写城市" length="50" errmsg="城市不能为空！" valid="required" value="<c:out value='${cp.city}' />" /></TD></TR>
        <TR>
          <TD 
          style="BORDER-RIGHT-WIDTH: 1px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px">证件类型&nbsp;&nbsp;&nbsp;&nbsp;</TD>
          <TD 
          ...
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><INPUT 
            ...
            errmsg="证件号码不能为空！" valid="required" value="<c:out value='${cp.id_number}' />" /></TD></TR>
        <TR>
          <TD 
          ...
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 1px"><SELECT 
            name="garden1">
             <OPTION value=" "></OPTION>
             <OPTION <c:if test="${cp.garden=='清华软件园'}">selected="true"</c:if> value="清华软件园">清华软件园</OPTION>
             <OPTION <c:if test="${cp.garden=='上海浦东软件园'}">selected="true"</c:if> value="上海浦东软件园">上海浦东软件园</OPTION>
             <OPTION <c:if test="${cp.garden=='杭州软件园'}">selected="true"</c:if> value="杭州软件园">杭州软件园</OPTION> 
             <OPTION <c:if test="${cp.garden=='江苏软件园'}">selected="true"</c:if> value="江苏软件园">江苏软件园</OPTION>
             <OPTION <c:if test="${cp.garden=='东大软件园'}">selected="true"</c:if> value="东大软件园">东大软件园</OPTION> 
             <OPTION <c:if test="${cp.garden=='齐鲁软件园'}">selected="true"</c:if> value="齐鲁软件园">齐鲁软件园</OPTION> 
             <OPTION <c:if test="${cp.garden=='西部软件园'}">selected="true"</c:if> value="西部软件园">西部软件园</OPTION>
            <OPTION <c:if test="${cp.garden=='长沙软件园'}">selected="true"</c:if> value="长沙软件园">长沙软件园</OPTION>
           <OPTION <c:if test="${cp.garden=='北京软件产业基地'}">selected="true"</c:if> value="北京软件产业基地">北京软件产业基地</OPTION>
           <OPTION <c:if test="${cp.garden=='天津华苑软件园'}">selected="true"</c:if> value="天津华苑软件园">天津华苑软件园</OPTION>
          <OPTION <c:if test="${cp.garden=='湖北软件产业基地'}">selected="true"</c:if> value="湖北软件产业基地">湖北软件产业基地</OPTION>
           <OPTION <c:if test="${cp.garden=='杭州高新软件园'}">selected="true"</c:if> value="杭州高新软件园">杭州高新软件园</OPTION>
          <OPTION <c:if test="${cp.garden=='福州软件园'}">selected="true"</c:if> value="福州软件园">福州软件园</OPTION> 
           <OPTION <c:if test="${cp.garden=='江西金庐软件园'}">selected="true"</c:if> value="江西金庐软件园">江西金庐软件园</OPTION>
          <OPTION <c:if test="${cp.garden=='西安软件园'}">selected="true"</c:if> value="西安软件园">西安软件园</OPTION>
          <OPTION <c:if test="${cp.garden=='大连软件园'}">selected="true"</c:if> value="大连软件园">大连软件园</OPTION> 
         <OPTION <c:if test="${cp.garden=='广州软件园'}">selected="true"</c:if> value="广州软件园">广州软件园</OPTION>
         <OPTION <c:if test="${cp.garden=='上海软件园'}">selected="true"</c:if> value="上海软件园">上海软件园</OPTION>
        <OPTION <c:if test="${cp.garden=='南京软件园'}">selected="true"</c:if> value="南京软件园">南京软件园</OPTION> 
         <OPTION <c:if test="${cp.garden=='长春软件园'}">selected="true"</c:if> value="长春软件园">长春软件园</OPTION>
          <OPTION <c:if test="${cp.garden=='厦门软件园'}">selected="true"</c:if> value="厦门软件园">厦门软件园</OPTION>
        <OPTION <c:if test="${cp.garden=='合肥软件园'}">selected="true"</c:if> value="合肥软件园">合肥软件园</OPTION> 
      <OPTION <c:if test="${cp.garden=='云南软件园'}">selected="true"</c:if> value="云南软件园">云南软件园</OPTION>
      <OPTION <c:if test="${cp.garden=='深圳软件园'}">selected="true"</c:if> value="深圳软件园">深圳软件园</OPTION>
      <OPTION <c:if test="${cp.garden=='兰州软件园'}">selected="true"</c:if> value="兰州软件园">兰州软件园</OPTION> 
      <OPTION <c:if test="${cp.garden=='青岛软件园'}">selected="true"</c:if> value="青岛软件园">青岛软件园</OPTION>
       <OPTION <c:if test="${cp.garden=='吉林软件园'}">selected="true"</c:if> value="吉林软件园">吉林软件园</OPTION>
      <OPTION <c:if test="${cp.garden=='中部软件产业园'}">selected="true"</c:if> value="中部软件产业园">中部软件产业园</OPTION> 
      <OPTION <c:if test="${cp.garden=='无锡软件园'}">selected="true"</c:if> value="无锡软件园">无锡软件园</OPTION>
      <OPTION <c:if test="${cp.garden=='苏州软件园'}">selected="true"</c:if> value="苏州软件园">苏州软件园</OPTION>
      <OPTION <c:if test="${cp.garden=='常州软件园'}">selected="true"</c:if> value="常州软件园">常州软件园</OPTION> 
     <OPTION <c:if test="${cp.garden=='宁波国际软件园'}">selected="true"</c:if> value="宁波国际软件园">宁波国际软件园</OPTION>
     <OPTION <c:if test="${cp.garden=='河北省软件产业基地（石家庄）'}">selected="true"</c:if> value="河北省软件产业基地（石家庄）">河北省软件产业基地（石家庄）</OPTION>
     <OPTION <c:if test="${cp.garden=='其他园区'}">selected="true"</c:if> value="其他园区">其他园区</OPTION>
     </SELECT> </TD>
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 1px">
            <DIV style="DISPLAY: block" id=busName>企业类别</DIV></TD>
          ...
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 1px">
          <c:choose>
          <c:when test="${cp.busType==''}">
          <DIV style="DISPLAY: none" id=busName1>
          </c:when>
          <c:otherwise>
             <DIV style="DISPLAY: block" id=busName1>
          </c:otherwise>
          </c:choose>
            <SELECT 
            onmousemove=cpcc_showtip(this.tips,this.valid,this.length,200) 
            ...
            errmsg="企业类别不能为空！" valid="required"> 
            <OPTION value="">--请选择企业类别--</OPTION>
            <OPTION <c:if test="${cp.busType=='国有企业'}">selected="true"</c:if> value="国有企业">国有企业</OPTION>
            <OPTION <c:if test="${cp.busType=='集体企业'}">selected="true"</c:if> value="集体企业">集体企业</OPTION>
            <OPTION <c:if test="${cp.busType=='私营企业'}">selected="true"</c:if> value="私营企业">私营企业</OPTION>
            <OPTION <c:if test="${cp.busType=='港澳台商投资企业'}">selected="true"</c:if> value="港澳台商投资企业">港澳台商投资企业</OPTION> 
            <OPTION <c:if test="${cp.busType=='外商投资企业'}">selected="true"</c:if> value="外商投资企业">外商投资企业</OPTION>
            <OPTION <c:if test="${cp.busType=='股份有限公司'}">selected="true"</c:if> value="股份有限公司">股份有限公司</OPTION>
            </SELECT> 
      </DIV>
      </TD></TR>
       <TR>
          
          <c:if test="${cpstats.index==0}">
          ...
          colSpan=3>
            ...
            tips="此著作权人如需证书副本请选择‘是’，如不要证书副本请选择‘否’"> 
            <OPTION selected value="">--请选择--</OPTION>
            <OPTION <c:if test="${cp.hasLetter=='是'}">selected="true"</c:if> value="是">是</OPTION>
           <OPTION  <c:if test="${cp.hasLetter=='否'}">selected="true"</c:if> value="否">否</OPTION>
           </SELECT></DIV>
            <DIV style="FLOAT: right"><INPUT onclick=deleteRow(this); value=删除 type=button>
            </DIV>
           </c:if>
  ...
  <TR>
    ...
    <TD class=contentbg><INPUT onclick=agent_showOrHide(this) name="applyType" 
      value="由著作权人申请"  type="radio" <c:if test="${r11.applyType=='由著作权人申请'}">checked="checked"</c:if> />由著作权人申请 <INPUT 
      onclick=agent_showOrHide(this) name="applyType" value="代理人" type="radio" 
      <c:if test="${r11.applyType=='代理人'}">checked="checked"</c:if>>由代理人申请 
    </TD></TR>
  <SCRIPT>
...
function setPeopleValue(str)
{
  ...
  <TR>
    <TD class=contentbg 
      ...
      valid="required"  value="<c:out value='${r11.agent_desc}' />" /> </TD></TR>
  <TR>
    <TD class=contentbg>姓名或单位名称</TD>
  ...
  <TR>
    <TD class=contentbg><INPUT 
      ...
      name="difmatReferMode" value="1"  type="radio" 
      tips="源程序的连续的前30页和连续的后30页（前、后30页可以是自然排序，也可以是自行定义；&nbsp;
      <br>提交一种文档的连续的前30页和连续的后30页，申请人可以选择提交一种以上的文档，每增加一种文档，缴纳80元的费用；&nbsp;<br>"
      <c:if test="${r11.difmatReferMode=='1'}">checked="checked"</c:if> />一般交存 
    </TD>
    <TD 
      class=contentbg>&nbsp;&nbsp;提交源程序前连续的30页和后连续的30页；<BR>&nbsp;&nbsp;提交任何一种文档的前连续的30页和后连续的30页；<BR>
      <INPUT 
      name="isMutilDoc" value="oneDoc" type="radio"
       <c:if test="${r11.isMutilDoc=='oneDoc'}">checked="checked"</c:if> />一种文档<BR><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,500) 
      onmouseout=cpcc_showtip() name="isMutilDoc" value="mutilDoc" type="radio" 
      tips="申请人可以选择提交一种以上的文档，每增加一种文档，需缴纳80元的费用。"
        <c:if test="${r11.isMutilDoc=='mutilDoc'}">checked="checked"</c:if> />多种文档，种类为： <INPUT 
      id="mutilDocType" 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,500) 
      onmouseout=cpcc_showtip() name="mutilDocType" value="<c:out value='${r11.mutilDocType}' />" size=10 
  ...
  <TR>
    <TD class=contentbg rowSpan=3><INPUT 
      ...
      <br>c.提交目标程序的前、后30页和源程序任选连续的20页（三种方式中选择其一）。&nbsp;<br>"
       <c:if test="${r11.difmatReferMode=='2'}">checked="checked"</c:if> />例外交存 
    </TD>
    <TD class=contentbg><INPUT  name="difmatReferModeExcep" value="exp1" 
      type="radio" <c:if test="${r11.difmatReferModeExcep=='exp1'}">checked="checked"</c:if> />
      使用黑色宽斜线覆盖，页码为： <INPUT id=difmatReferPages 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350)  
      onmouseout=cpcc_showtip() name="difmatReferPages" size=50 
      tips="填写需要覆盖的程序或文档的页码。覆盖的页数不能超过提交源程序或文档的百分之五十，覆盖由登记机构实施。" length="100"
       value="${r11.difmatReferPages}" /> 
  </TD></TR>
  <TR>
    <TD class=contentbg><INPUT disabled name="difmatReferModeExcep" value="exp2" 
      type=radio <c:if test="${r11.difmatReferModeExcep=='exp2'}">checked="checked"</c:if> />前10页和任选连续的50页</TD></TR>
  <TR>
    <TD class=contentbg><INPUT disabled name="difmatReferModeExcep" value="exp3" 
      type=radio <c:if test="${r11.difmatReferModeExcep=='exp3'}">checked="checked"</c:if> />目标程序的连续的前、后各30页和源程序任选连续的20页
    </td></tr></tbody>
					</table>
				</div>
<TABLE align=center>
...
$(document).ready(function() {
	var developCircs = "${r11.developCircs}";
	var origSoftRegCircs = "${r11.origSoftRegCircs}";
	if(developCircs==2) {
		$("#xgxx").css("display","block");
		$("#smxx").css("display","block");
	  if(origSoftRegCircs==0) {
		  $("#ydjxx").css("display","block");
	 }	
	}
	var publishStatus = "${r11.publishStatus}";
	if(publishStatus == 1) {
		$("#pubstate").css("display","block");
	}
	var  rightObtainMode = "${r11.rightObtainMode}";
	if(rightObtainMode == 1) {
