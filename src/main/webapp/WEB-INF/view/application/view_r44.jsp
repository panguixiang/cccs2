...
<head>
<title>在线查看-撤销或放弃计算机软件登记申请    </title>
...
border=0 cellSpacing=0 cellPadding=0 width="100%" align=center>
  ...
  <TR>
    ...
    style="BORDER-BOTTOM: gray 0px solid; BORDER-LEFT: gray 0px solid; VERTICAL-ALIGN: middle; BORDER-TOP: gray 0px solid; BORDER-RIGHT: gray 0px solid">
      <DIV class=title>撤销或放弃计算机软件登记申请表</DIV></TD></TR></TBODY></TABLE>
<TABLE border=2 cellSpacing=0 cellPadding=0 width="100%" align=center>
  ...
  <TR>
    ...
    <TD>
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR height=30>
          <TH width=102>变更/补充<BR>登记证明编号</TH>
          <TD width=528 colSpan=3><c:out value='${r43_4.originalChangeNumber}' /></TD></TR>
        <TR height=40>
          <TH width=102>软件名称<BR>及版本号</TH>
          <TD class=InputTd width=528 colSpan=3><SPAN 
            class=suporsub><c:out value='${r43_4.softName}' /></SPAN></TD></TR>
        <TR height=30>
          <TH width=102>撤销登记理由</TH>
          <TD class=InputTd width=528 
    colSpan=3><c:out value='${r43_4.reason}' /></TD></TR></TBODY></TABLE></TD></TR>
  <TR>
    <TD colSpan=5>
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        <TBODY>
        <TR>
          ...
          <TD style="WIDTH: 530px" class=InputTd 
            colSpan=3> 
            <c:if test="${r43_4.applyType=='由软件登记人办理'}">⊙</c:if>
			<c:if test="${r43_4.applyType!='由软件登记人办理'}">○</c:if>由软件登记人办理&nbsp;&nbsp;
  ...
  <c:if test="${r43_4.hasGtsqr == '有共同登记人'}">
  <TR style="HEIGHT: 20px">
    <TD class=InputTd 
      colSpan=2>&nbsp;&nbsp;共同登记人名称:<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${r43_4.gtsqrName}<BR>&nbsp;&nbsp;
      共同登记人意见:<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${r43_4.gtsqrIdea}<BR>
      <DIV 
      align=right>共同登记人签章：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</DIV>
...
<TABLE border=2 cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    ...
    <TD class=InputTd>
      <DIV style="FLOAT: left">1、陈述撤销登记理由</DIV>
      <DIV style="FLOAT: right">一式一份</DIV><BR></TD></TR></TBODY></TABLE>
<DIV style="MARGIN: 10px; WIDTH: 630px; FONT-SIZE: 14px">
<P 
style="MARGIN-TOP: 5px"><B>提交材料说明：</B></P>1、以上材料清单由系统根据你填写的申请表内容自动生成，请打印此清单后按要求准备好相应材料；
<BR>2、准备好申请材料后将材料的份数页数手写在提交材料清单上，装订在一起与登记申请表一起寄出。 
</DIV></DIV></BODY></HTML>