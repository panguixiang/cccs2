...
<head>
<title>在线查看-变更出版境外音像制品合同登记申请表</title>
<STYLE>TABLE {
...
TH {
	BORDER-BOTTOM-COLOR: #333333; TEXT-ALIGN: center; BORDER-TOP-COLOR: #333333; HEIGHT: 25px; BORDER-RIGHT-COLOR: #333333; FONT-SIZE: 14px; VERTICAL-ALIGN: middle; BORDER-LEFT-COLOR: #333333; FONT-WEIGHT: normal
}
UNKNOWN {
...
border=0 cellSpacing=0 cellPadding=0 width="100%" align=center>
  ...
  <TR>
    ...
    style="BORDER-BOTTOM: gray 0px solid; BORDER-LEFT: gray 0px solid; VERTICAL-ALIGN: middle; BORDER-TOP: gray 0px solid; BORDER-RIGHT: gray 0px solid">
      <DIV class=title>变更出版境外音像制品合同登记申请表</DIV></TD></TR></TBODY></TABLE>
  ...
  <TR>
    <TD>
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        <TBODY>
        <TR>
          <TH style="WIDTH: 100px" class=FenLeiInfo colSpan=4>原登记信息</TH></TR>
        <TR>
          <TH style="WIDTH: 100px">原登记类型</TH>
          <TD class=InputTd colSpan=3>
           <c:if test="${z75.register_type!='录音制品'}">○&nbsp;录音制品</c:if>
		   <c:if test="${z75.register_type=='录音制品'}">⊙&nbsp;录音制品</c:if> 
		   <c:if test="${z75.register_type!='影视作品'}">○&nbsp;影视作品</c:if>
		   <c:if test="${z75.register_type=='影视作品'}">⊙&nbsp;影视作品</c:if> 
          </TD></TR>
        <TR>
          <TH>名称 </TH>
          <TD class=InputTd colSpan=3>
            ...
            width="100%">
              ...
              <TR>
                ...
                vAlign=bottom><c:out value='${z75.cn_opus_name}' /></TD></TR>
              <TR>
                <TD 
                style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
                ...
                <TD 
                style="BORDER-RIGHT-WIDTH: 0px; WIDTH: 90%; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" 
                vAlign=top><c:out value='${z75.en_opus_name}' /></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
          <TH>出版类型</TH>
          <TD class=InputTd colSpan=3><c:out value='${z75.publish_type}' /></TD></TR>
        <TR>
          <TH>原登记号</TH>
          <TD class=InputTd colSpan=3><c:out value='${z75.original_reg_num}' /></TD></TR>
        <TR>
          <TH>原登记日期</TH>
          <TD class=InputTd colSpan=3><c:out value='${z75.register_date}' /></TD></TR>
        <TR>
          <TH>出版单位名称</TH>
          <TD class=InputTd colSpan=3><c:out value='${z75.publis_comp_name}' /></TD></TR>
        <TR>
          <TH style="WIDTH: 100px" class=FenLeiInfo colSpan=4>变更信息 </TD></TR>
        <TR>
          <TD colSpan=4>
            <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" 
              frame=void><TBODY>
              <TR>
                <TH width=100>变更事项</TH>
                <TH>变更前内容</TH>
                <TH>变更后内容</TH></TR>
                <c:forEach items="${infos}" var="info">
                 <TR>
                <TH style="WIDTH: 100px"><c:out value='${info.item}' /></TH>
                <TD class=InputTd><c:out value='${info.before_content}' /></TD>
                <TD class=InputTd><c:out value='${info.after_content}' /></TD></TR>
                <TR>
				</c:forEach>
           </TBODY></TABLE></TD></TR>
        <TR>
          <TH>变更理由说明 </TH>
          <TD class=InputTd><c:out value='${z75.rev_desc}' /></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE>
...
<TABLE border=2 cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    <TD colSpan=2>
      ...
      <c:if test="${z75.apply_type!='原出版单位申请'}">○&nbsp;原出版单位申请</c:if>
	  <c:if test="${z75.apply_type=='原出版单位申请'}">⊙&nbsp;原出版单位申请</c:if>
	  <c:if test="${z75.apply_type!='代理人'}">○&nbsp;由代理人申请</c:if>
	  <c:if test="${z75.apply_type=='代理人'}">⊙&nbsp;由代理人申请</c:if>
      ...
      <TABLE border=1 cellSpacing=0 cellPadding=0 width="100%" frame=void>
        ...
        <TR height=80>
          <TD style="WIDTH: 630px" class=InputTd colSpan=4>
            ...
            id=agentDescU><c:out value='${z75.agent_desc}' /></U> </DIV></TD></TR>
        <TR height=50>
          <TH style="WIDTH: 100px">姓名或名称</TH>
...
<TABLE border=2 cellSpacing=0 cellPadding=0 width="100%">
  ...
  <TR>
    <TH>证明文件</TH>
    <TD class=InputTd>
      <DIV style="FLOAT: left">1、原登记合同批复（白联）</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">2、代理委托书</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
      <DIV style="FLOAT: left">3、代理人身份证明</DIV>
      <DIV style="FLOAT: right">&nbsp;&nbsp;份/&nbsp;&nbsp;页</DIV><BR>
