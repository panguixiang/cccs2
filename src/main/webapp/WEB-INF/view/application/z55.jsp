...
border=0 cellSpacing=0 cellPadding=0 width="80%" align=center>
  ...
  <TR>
    <TD class="contentbg small_title" colSpan=2><SPAN 
      class=datacell>原质权登记信息</SPAN></TD></TR>
  <TR>
    <TD class=contentbg><SPAN class=datacell>受理号</SPAN></TD>
    <TD class=contentbg><INPUT 
      ...
      errmsg="质权登记号不能为空!" valid="required" value="<c:out value='${z55.originalRegNumber}' />" /> </TD></TR>
  <TR>
    <TD class=contentbg><SPAN class=datacell>受理日期</SPAN></TD>
    <TD class=contentbg><INPUT 
      onmousemove=cpcc_showtip(this.tips,this.valid,this.length,350) 
      onmouseout=cpcc_showtip() onclick="fPopCalendar(this, this);" 
      name=applyingType readOnly tips="请填写登记日期" errmsg="登记日期不能为空!" 
      valid="required" value="<c:out value='${z55.applyingType}' />" /> </TD></TR>
  <TR>
    ...
    <TD class=contentbg><INPUT style="WIDTH: 448px" id=opusName 
      ...
      length="200" errmsg="作品名称不能为空!" valid="required" value="<c:out value='${z55.reason}' />" /> </TD></TR>
 
    
     <TR>
    <TD class="contentbg small_title" colSpan=2><SPAN 
      class=datacell>撤回简况</SPAN></TD></TR>
  <TR>
    <TD class=contentbg><SPAN class=datacell>撤回登记理由</SPAN></TD>
    <TD class=contentbg>
    ...
    errmsg="申请注销理由不能为空!" valid="required"><c:out value='${z55.softFullName}' /></TEXTAREA> 
    </TD></TR>
    ...
    id=personData1 class=contentbg colSpan=2>
      ...
      <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          <TD 
          style="BORDER-RIGHT-WIDTH: 0px; BORDER-TOP-WIDTH: 1px; BORDER-BOTTOM-WIDTH: 1px; BORDER-LEFT-WIDTH: 1px"><SELECT 
            style="WIDTH: 115px" name=impawnType2>  
  ...
  <TR>
    ...
    <TD class=contentbg>
     <c:choose>
    <c:when test="${empty z55}">
   <INPUT id=applyType name=applyType value=出质人和质权人申办 CHECKED 
      type=radio />出质人和质权人申办 
     <INPUT onclick=s_h_agent(this) name=isAgent value=代理人 
      type=checkbox />由代理人申请
    </c:when>
    <c:otherwise>
   <INPUT id=applyType name=applyType value=出质人和质权人申办 
      type=radio <c:if test="${z55.applyType=='出质人和质权人申办'}">CHECKED</c:if> />出质人和质权人申办
  <INPUT onclick=s_h_agent(this) name=isAgent value=代理人 type=checkbox 
  <c:if test="${z55.isAgent=='代理人'}">CHECKED</c:if> />由代理人申请
    </c:otherwise>
    </c:choose>
    </TD></TR>
  <SCRIPT>
  ...
  <TR>
    <TD class=contentbg 
      ...
      valid="required" value="<c:out value='${z55.agent_desc}' />" /> </TD></TR>
  <TR>
    <TD class=contentbg>姓名或名称</TD>
...
<TABLE align=center style="background-color:#fff;">
  ...
  <TR>
   ...
   <input type="button" value="保存" id="saveId" 
			 class="m_button" onClick="onlySaveForm('${pageContext.request.contextPath}/application/z53and6/save/z55');"/>
    </TD>
    <TD width=50 style="padding-right:15px;">
    <input type="button" value="提交" id="subId" class="m_button" 
    onClick="subForm('${pageContext.request.contextPath}/application/z53and6/submit/z55');"/>
    </TD>
   <td>
